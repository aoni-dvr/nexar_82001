...
cp ${AMBA_CUST_DIR}/etc/init.d/S60amba_camera_service_bub ${TARGET_DIR}/etc/init.d/S60amba_camera_service
cp ${AMBA_CUST_DIR}/etc/init.d/S99bootdone ${TARGET_DIR}/etc/init.d/
cp ${AMBA_CUST_DIR}/etc/exports ${TARGET_DIR}/etc/exports
cp ${AMBA_CUST_DIR}/etc/network/interfaces_bub ${TARGET_DIR}/etc/network/interfaces
