...
cp ${AMBARELLA_PKG_DIR}/supercam/cam_config_lnx2.sh ${TARGET_DIR}/usr/local/share/script
chmod +x ${TARGET_DIR}/usr/local/share/script/cam_config_lnx2.sh
echo "/usr/local/share/script/cam_config_lnx2.sh" >> ${TARGET_DIR}/etc/init.d/S50service
