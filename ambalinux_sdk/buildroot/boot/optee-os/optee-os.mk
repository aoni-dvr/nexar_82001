...
override OPTEE_OS_VERSION = amba
override OPTEE_OS_SITE_METHOD = local
override OPTEE_OS_SITE = $(AMBARELLA_PKG_DIR)/optee_os
override BR_NO_CHECK_HASH_FOR += $(OPTEE_OS_SOURCE)
