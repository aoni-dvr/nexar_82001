...
struct ambarella_dma_ops {
	void (* set_channel_id)(int chan_id_index, struct ambdma_device *amb_dma, u32 request, u32 chan_id);
};

struct ambarella_dma_soc_data {
	const int nr_regs;
	const struct ambarella_dma_ops *ops;
};
...
struct ambdma_device {
	...
	const struct ambarella_dma_soc_data *soc_data;
