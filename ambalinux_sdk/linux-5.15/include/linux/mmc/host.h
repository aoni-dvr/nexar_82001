...
extern void ambarella_sd_init_bus_lock(struct mmc_host *mmc, unsigned int irq);
extern void ambarella_sd_request_bus(struct mmc_host *mmc);
extern void ambarella_sd_release_bus(struct mmc_host *mmc);
