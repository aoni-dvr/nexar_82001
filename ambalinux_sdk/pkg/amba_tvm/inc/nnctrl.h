/*******************************************************************************
 * @file nnctrl.h
 * @brief This file defines nnctrl API specification
 * nnctrl.h
 *
 * History:
...
struct net_mem {
	...
	cv_daddr_t phy_addr;  /*!< The absolute physical address */
...
struct input_desc {
	...
	INOUT cv_daddr_t addr;  /*!< Input absolute physical address.
...
struct output_desc {
	...
	INOUT cv_daddr_t addr;  /*!< Output absolute physical address.
		* Set by APP if set no_mem, otherwise get from Library */
...
struct net_dvi_cfg {
	...
	cv_daddr_t addr;  /*!< The absolute physical address */
