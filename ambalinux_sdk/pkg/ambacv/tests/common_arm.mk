...
ifndef PREBUILDDIR
PREBUILDDIR := $(CMNDIR)/libs/arm/$(APP_TYPE)
endif
export PREBUILDDIR
...
ifndef CVLIB_LIST_INC
ifneq ($(wildcard cvlib_list.inc),)
CVLIB_LIST_INC := $(CURDIR)/cvlib_list.inc
else ifneq ($(wildcard $(BUILDDIR)/../arm/cvlib_list.inc),)
CVLIB_LIST_INC := $(BUILDDIR)/../arm/cvlib_list.inc
else ifneq ($(wildcard $(FMWDIR)/app/$(APP_NAME)/cvlib_list.inc),)
CVLIB_LIST_INC := $(FMWDIR)/app/$(APP_NAME)/cvlib_list.inc
else
CVLIB_LIST_INC := 
endif
endif
export CVLIB_LIST_INC
