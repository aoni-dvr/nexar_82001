...
/**
 * Use more parameters for smc call
 */
unsigned long thread_smc_ex(unsigned long func_id, unsigned long a1,
			unsigned long a2, unsigned long a3, unsigned long a4, void *a5,
			void *a6, unsigned long a7);
