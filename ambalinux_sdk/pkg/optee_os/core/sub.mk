...
GEN_PUB_KEY_WITH_PRC_TOOLKIT ?= \
	$(AMB_TOPDIR)/packages/security/build/tz_dev_proxy/optee_get_pub_c_proxy
...
recipe-ta_pub_key = $(GEN_PUB_KEY_WITH_PRC_TOOLKIT) \
				--localport $(HOST_PROXY_PORT) \
				--out $(sub-dir-out)/ta_pub_key.c
else
