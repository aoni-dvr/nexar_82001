...
ifeq ($(CONFIG_USE_RPC_TOOLKIT), y)
SIGN_WITH_PRC_TOOLKIT ?= $(AMB_TOPDIR)/packages/security/build/tz_dev_proxy/optee_sign_proxy
else
...
ifeq ($(CONFIG_USE_RPC_TOOLKIT), y)
	$(q)$(SIGN_WITH_PRC_TOOLKIT) --optee_version 3_15_0 $$(crypt-args$(user-ta-uuid)) --uuid $(user-ta-uuid) --version $(user-ta-version) \
		--localport $(HOST_PROXY_PORT) \
		--in $$< --out $$@
else
