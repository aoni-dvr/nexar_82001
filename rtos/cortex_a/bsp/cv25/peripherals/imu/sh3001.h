...
******************************************************************/
#define SH3001_ADDRESS				(SLAVE_ADDR)		
...
extern void SH3001_FIFO_Read_Data(unsigned char *fifoReadData, unsigned short int fifoDataLength);
// Master I2C related fucntions
extern void SH3001_MI2C_Reset(void);
extern void SH3001_MI2C_Bus_Config(unsigned char mi2cReadMode, unsigned char mi2cODR, unsigned char mi2cFreq);
extern void SH3001_MI2C_Cmd_Config(unsigned char mi2cSlaveAddr, unsigned char mi2cSlaveCmd, unsigned char mi2cReadMode);
#endif
