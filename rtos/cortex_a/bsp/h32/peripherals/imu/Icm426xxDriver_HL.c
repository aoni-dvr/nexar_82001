...
static void inv_icm426xx_sleep_us(unsigned int us)
{
    unsigned int ms = us / 1000;
    if (ms == 0) {
        ms = 1;
    }
    debug_line("inv_icm426xx_sleep_us called %d", us);
    msleep(us / 1000);
}

static unsigned int inv_icm426xx_get_time_us(void)
{
    debug_line("inv_icm426xx_get_time_us called");
...
int inv_icm426xx_get_data_from_registers(struct inv_icm426xx * s, inv_icm426xx_sensor_event_t *event)
{
	int status = 0;
	//uint8_t int_status;
