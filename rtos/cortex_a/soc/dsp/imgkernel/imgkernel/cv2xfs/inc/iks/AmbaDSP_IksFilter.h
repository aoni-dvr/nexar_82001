...
uint32 iks_set_safety_info(uint32 context_id, const ik_safety_info_t *p_safety_info);
uint32 iks_get_safety_info(uint32 context_id, ik_safety_info_t *p_safety_info);
...
uint32 iks_set_pre_cc_gain(uint32 context_id, const ik_pre_cc_gain_t *p_pre_cc_gain);
uint32 iks_get_pre_cc_gain(uint32 context_id, ik_pre_cc_gain_t *p_pre_cc_gain);
...
uint32 iks_set_wide_chroma_filter(uint32 context_id, const ik_wide_chroma_filter_t *p_wide_chroma_filter);
uint32 iks_get_wide_chroma_filter(uint32 context_id, ik_wide_chroma_filter_t *p_wide_chroma_filter);
...
uint32 iks_set_burst_tile(uint32 context_id, const ik_burst_tile_t *p_burst_tile);
uint32 iks_get_burst_tile(uint32 context_id, ik_burst_tile_t *p_burst_tile);
