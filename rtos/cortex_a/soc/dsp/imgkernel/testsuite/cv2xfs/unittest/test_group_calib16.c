...
static INT16 WarpHor[2*128*96];
static INT16 WarpVer[2*128*96];
...
static void _Init_Image_Kernel(AMBA_IK_ABILITY_s *p_ability)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_QueryArchMemorySize", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_InitArch(&ContextSetting, (void*)ik_working_buffer, sizeof(ik_working_buffer));
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitArch", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_InitDefBinary(pBinDataAddr);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitDefBinary", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_InitCheckParamFunc();
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitCheckParamFunc", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetDebugLogId(255U, 1U);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_SetDebugLogId", "OK case in ik_ctest_calib16.c", id_cnt++);
}
...
static void _GData_SystemExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    _System.SensorMode = 1;
    _System.Ability = AMBA_IK_VIDEO_LINEAR;

    rval = AmbaIK_GetWindowSizeInfo(pMode, &WindowSizeInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWindowSizeInfo", "OK case in ik_ctest_calib16.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWindowSizeInfo", "OK case in ik_ctest_calib16.c", id_cnt++);

    // Update Flip Info
    FlipInfo = 0UL;
    rval = AmbaIK_SetFlipMode(pMode, FlipInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFlipMode", "OK case in ik_ctest_calib16.c", id_cnt++);
...
static void _GData_VinSensorExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVinSensorInfo", "OK case in ik_ctest_calib16.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVinSensorInfo", "OK case in ik_ctest_calib16.c", id_cnt++);
}
...
static void _GData_RgbIrExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetRgbIr", "OK case in ik_ctest_calib16.c", id_cnt++);
}
...
static void _GData_Raw2RawExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFeToneCurve", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetFeStaticBlc(pMode, &GData.StaticBlackLevel[0], 0UL);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFeStaticBlc", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetDynamicBadPxlCor(pMode, &GData.DynamicBadPixelCorrection);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDynamicBadPxlCor", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetCfaLeakageFilter(pMode, &GData.CfaLeakageFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCfaLeakageFilter", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetCfaNoiseFilter(pMode, &GData.CfaNoiseFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCfaNoiseFilter", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetAntiAliasing(pMode, &GData.AntiAliasing);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAntiAliasing", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetFeWbGain(pMode, &GData.FrontEndWbGain[0], 0UL);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFeWbGain", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetAfterCeWbGain(pMode, &GData.AfterCeWbGain);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAfterCeWbGain", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetBeforeCeWbGain(pMode, &GData.BeforeCeWbGain);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetBeforeCeWbGain", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetDemosaic(pMode, &GData.DemosaicFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDemosaic", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetGrgbMismatch(pMode, &GData.GbGrMismatch);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetGrgbMismatch", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetRgbTo12Y(pMode, &GData.RgbTo12Y);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetRgbTo12Y", "OK case in ik_ctest_calib16.c", id_cnt++);
}
...
static void _GData_Yuv2YuvExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    {
        pBinFile = fopen("../util/bin/mn34220pl_1lux_cc_3d.bin", "rb");
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetColorCorrection", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetToneCurve(pMode, &GData.ToneCurve);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetToneCurve", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetRgbToYuvMatrix(pMode, &GData.RgbToYuvMatrix);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetRgbToYuvMatrix", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetChromaScale(pMode, &GData.ChromaScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaScale", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetChromaMedianFilter(pMode, &GData.ChromaMedianFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaMedianFilter", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetChromaFilter(pMode, &GData.ChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaFilter", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetWideChromaFilter(pMode, &GData.WideChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWideChromaFilter", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetWideChromaFilterCombine(pMode, &GData.WideChromaFilterCombine);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWideChromaFilterCombine", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetLumaNoiseReduction(pMode, &GData.LumaNoiseReduction);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetLumaNoiseReduction", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetFirstLumaProcMode(pMode, &GData.FirstLumaProcessMode);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFirstLumaProcMode", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetAdvSpatFltr(pMode, &GData.AsfInfo.AsfInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAdvSpatFltr", "OK case in ik_ctest_calib16.c", id_cnt++);
}
...
static void _GData_MctfExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsBoth", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsBothTdt(pMode, &GData.FinalSharpenBoth.ThreedTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsBothTdt", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsNoise(pMode, &GData.FinalSharpenNoise);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsNoise", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsFir(pMode, &GData.FinalFir);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsFir", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsCoring(pMode, &GData.FinalCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsCoring", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsCorIdxScl(pMode, &GData.FinalCoringIndexScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsCorIdxScl", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsMinCorRst(pMode, &GData.FinalMinCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsMinCorRst", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsMaxCorRst(pMode, &GData.FinalMaxCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsMaxCorRst", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsSclCor(pMode, &GData.FinalScaleCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsSclCor", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetVideoMctf(pMode, &GData.VideoMctf);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctf", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetVideoMctfTa(pMode, &GData.VideoMctfTemporalAdjust);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctfTa", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval = AmbaIK_SetVideoMctfAndFnlshp(pMode, &GData.VideoMctfAndFinalSharpen);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctfAndFnlshp", "OK case in ik_ctest_calib16.c", id_cnt++);
}
...
static void _GData_Raw2yuvCalibExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVinActiveWin", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetDummyMarginRange(pMode, &GData.Dummy);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDummyMarginRange", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetDzoomInfo(pMode, &GData.Dzoom);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDzoomInfo", "OK case in ik_ctest_calib16.c", id_cnt++);

    GData.SbpInternal.pMap = FPNMap;
    {
        pBinFile = fopen("../util/bin/sbp_map_4608_3600.bin", "rb");

        BinSize = ((GData.SbpInternal.PixelMapPitch<<3UL) * GData.SbpInternal.PixelMapHeight) >> 3;

        fread(FPNMap, 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    rval= AmbaIK_SetStaticBpcInternal(pMode, &GData.SbpInternal);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetStaticBpcInternal", "OK case in ik_ctest_calib16.c", id_cnt++);

    {
        pBinFile = fopen("../util/bin/vig_gain.bin", "rb");

        BinSize = ITUNER_VIGNETTE_GAIN_MAP_MULT_SIZE;

        fread(&GData.VignetteCompensation.VignetteInfo.CalibVignetteInfo.VigGainTblR[0][0], 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    rval= AmbaIK_SetVignette(pMode, &GData.VignetteCompensation.VignetteInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVignette", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetVignetteEnb(pMode, GData.VignetteCompensation.Enable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVignetteEnb", "OK case in ik_ctest_calib16.c", id_cnt++);
    rval= AmbaIK_SetCawarpEnb(pMode, 1);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCawarpEnb", "OK case in ik_ctest_calib16.c", id_cnt++);

    {
        pBinFile = fopen("../util/bin/19_ca_warp_horizontal_table_red.bin", "rb");

        BinSize = sizeof(INT16)*32UL*48UL;

        fread(&GData.CAInternal.WarpHorzTableRed[0], 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    {
        pBinFile = fopen("../util/bin/20_ca_warp_horizontal_table_blue.bin", "rb");

        BinSize = sizeof(INT16)*32UL*48UL;

        fread(&GData.CAInternal.WarpHorzTableBlue[0], 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    {
        pBinFile = fopen("../util/bin/21_ca_warp_vertical_table_red.bin", "rb");

        BinSize = sizeof(INT16)*32UL*48UL;

        fread(&GData.CAInternal.WarpVertTableRed[0], 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    {
        pBinFile = fopen("../util/bin/22_ca_warp_vertical_table_blue.bin", "rb");

        BinSize = sizeof(INT16)*32UL*48UL;

        fread(&GData.CAInternal.WarpVertTableBlue[0], 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    rval= AmbaIK_SetCaWarpInternal(pMode, &GData.CAInternal);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCaWarpInternal", "OK case in ik_ctest_calib16.c", id_cnt++);

    GData.WarpInternal.pWarpHorizontalTable = WarpHor;
    {
        pBinFile = fopen("../util/bin/warp_horizontal_table_logical.bin", "rb");

        fseek(pBinFile, 0, SEEK_END);
        BinSize = ftell(pBinFile);
        rewind(pBinFile);

        fread(WarpHor, 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    GData.WarpInternal.pWarpVerticalTable = WarpVer;
    {
        pBinFile = fopen("../util/bin/warp_vertical_table_logical.bin", "rb");

        fseek(pBinFile, 0, SEEK_END);
        BinSize = ftell(pBinFile);
        rewind(pBinFile);

        fread(WarpVer, 1, BinSize, pBinFile);
        fclose(pBinFile);
    }
    rval= AmbaIK_SetWarpInternal(pMode, &GData.WarpInternal);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWarpInternal", "OK case in ik_ctest_calib16.c", id_cnt++);
}
...
static void _GData_Execute(const AMBA_IK_MODE_CFG_s *pMode, AMBA_IK_ABILITY_s *pAbility)
{
    ...
    {
        pBinFile = fopen("../util/bin/calib16_gdata.bin", "rb");
...
static void _GData_Raw2yuvCalibRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    rval = AmbaIK_GetWarpInternal(pMode, &GDataGet.WarpInternal);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWarpInternal", "OK case in ik_ctest_hdr20.c", id_cnt++);

    GDataGet.WarpCompensationDzoomInternal.Enable = GDataGet.WarpInternal.Enable;
    GDataGet.WarpCompensationDzoomInternal.GridArrayWidth = GDataGet.WarpInternal.GridArrayWidth;
    GDataGet.WarpCompensationDzoomInternal.GridArrayHeight = GDataGet.WarpInternal.GridArrayHeight;
    GDataGet.WarpCompensationDzoomInternal.HorzGridSpacingExponent = GDataGet.WarpInternal.HorzGridSpacingExponent;
    GDataGet.WarpCompensationDzoomInternal.VertGridSpacingExponent = GDataGet.WarpInternal.VertGridSpacingExponent;
    GDataGet.WarpCompensationDzoomInternal.VertWarpGridArrayWidth = GDataGet.WarpInternal.VertWarpGridArrayWidth;
    GDataGet.WarpCompensationDzoomInternal.VertWarpGridArrayHeight = GDataGet.WarpInternal.VertWarpGridArrayHeight;
    GDataGet.WarpCompensationDzoomInternal.VertWarpHorzGridSpacingExponent = GDataGet.WarpInternal.VertWarpHorzGridSpacingExponent;
    GDataGet.WarpCompensationDzoomInternal.VertWarpVertGridSpacingExponent = GDataGet.WarpInternal.VertWarpVertGridSpacingExponent;
    GDataGet.WarpInternal.pWarpHorizontalTable = NULL; // hack the addresses to all 0, we don't compare memory addresses.
    GDataGet.WarpInternal.pWarpVerticalTable = NULL; // hack the addresses to all 0, we don't compare memory addresses.

    rval = AmbaIK_GetCaWarpInternal(pMode, &GDataGet.CAInternal);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetCaWarpInternal", "OK case in ik_ctest_hdr20.c", id_cnt++);

    GDataGet.ChromaAberrationInfoInternal.HorzPassGridArrayHeight = GDataGet.CAInternal.HorzPassGridArrayHeight;
    GDataGet.ChromaAberrationInfoInternal.HorzPassGridArrayWidth = GDataGet.CAInternal.HorzPassGridArrayWidth;
    GDataGet.ChromaAberrationInfoInternal.HorzPassHorzGridSpacingExponent = GDataGet.CAInternal.HorzPassHorzGridSpacingExponent;
    GDataGet.ChromaAberrationInfoInternal.HorzPassVertGridSpacingExponent = GDataGet.CAInternal.HorzPassVertGridSpacingExponent;
    GDataGet.ChromaAberrationInfoInternal.HorzWarpEnable = GDataGet.CAInternal.HorzWarpEnable;
    GDataGet.ChromaAberrationInfoInternal.VertPassGridArrayHeight = GDataGet.CAInternal.VertPassGridArrayHeight;
    GDataGet.ChromaAberrationInfoInternal.VertPassGridArrayWidth = GDataGet.CAInternal.VertPassGridArrayWidth;
    GDataGet.ChromaAberrationInfoInternal.VertPassHorzGridSpacingExponent = GDataGet.CAInternal.VertPassHorzGridSpacingExponent;
    GDataGet.ChromaAberrationInfoInternal.VertPassVertGridSpacingExponent = GDataGet.CAInternal.VertPassVertGridSpacingExponent;
    GDataGet.ChromaAberrationInfoInternal.VertWarpEnable = GDataGet.CAInternal.VertWarpEnable;
    ...
    GDataGet.VignetteCompensation.Enable = (UINT8)enable;

    rval = AmbaIK_GetStaticBpcInternal(pMode, &GDataGet.SbpInternal);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetStaticBpcInternal", "OK case in ik_ctest_hdr20.c", id_cnt++);
    GDataGet.StaticBadPixelCorrectionInternal.Enable = GDataGet.SbpInternal.Enable;
    GDataGet.StaticBadPixelCorrectionInternal.PixelMapWidth = GDataGet.SbpInternal.PixelMapWidth;
    GDataGet.StaticBadPixelCorrectionInternal.PixelMapHeight = GDataGet.SbpInternal.PixelMapHeight;
    GDataGet.StaticBadPixelCorrectionInternal.PixelMapPitch = GDataGet.SbpInternal.PixelMapPitch;
    GDataGet.SbpInternal.pMap = NULL; // hack the addresses to all 0, we don't compare memory addresses.
}
...
static void _GData_Refresh(const AMBA_IK_MODE_CFG_s *pMode, AMBA_IK_ABILITY_s *pAbility)
{
    ...
    {
        pBinFile = fopen("data/ik_ctest_calib16_gdata_get.bin", "wb");
...
INT32 ik_ctest_calib16_main(void)
{
    ...
    memset(WarpHor, 0, sizeof(WarpHor));
    memset(WarpVer, 0, sizeof(WarpVer));
    id_cnt = 0;

    pFile = fopen("data/ik_ctest_calib16.txt", "w");
    ...
    LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitContext", "OK case in ik_ctest_calib16.c", id_cnt++);

    // test set
    _GData_Execute(&Mode, &Ability);

    Rval |= AmbaIK_ExecuteConfig(&Mode, &ExecuteContainer);
    LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_ExecuteConfig", "OK case in ik_ctest_calib16.c", id_cnt++);

    {
        ...
        LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_QueryDebugConfigSize", "OK case in ik_ctest_calib16.c", id_cnt++);
        ...
        LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_DumpDebugConfig", "OK case in ik_ctest_calib16.c", id_cnt++);
...

        {
            ...
            fid = fopen("data/ik_ctest_calib16.bin", "wb");
