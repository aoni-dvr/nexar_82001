...
static void _Init_Image_Kernel(AMBA_IK_ABILITY_s *p_ability)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_QueryArchMemorySize", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_InitArch(&ContextSetting, (void*)ik_working_buffer, sizeof(ik_working_buffer));
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitArch", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_InitDefBinary(pBinDataAddr);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitDefBinary", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_InitCheckParamFunc();
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitCheckParamFunc", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetDebugLogId(255U, 1U);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_SetDebugLogId", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_SystemExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    _System.SensorMode = 1;//for ir_only = 1
    _System.Ability = AMBA_IK_VIDEO_HDR_EXPO_3;

    rval = AmbaIK_GetWindowSizeInfo(pMode, &WindowSizeInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWindowSizeInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWindowSizeInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);

    // Update Flip Info
    FlipInfo = 0UL;
    rval = AmbaIK_SetFlipMode(pMode, FlipInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFlipMode", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...
#if 1
    {
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAwbStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAeStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAfStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetPgAfStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAfStatExInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetPgAfStatExInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetHistogramInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetPgHistogramInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    }

    {
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetResampStrength", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    }

    {
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_SetSafetyInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    }
#endif
}
...
static void _GData_VinSensorExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVinSensorInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVinSensorInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_RgbIrExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetRgbIr", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_Raw2RawExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFeToneCurve", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetFeStaticBlc(pMode, &GData.StaticBlackLevel[0], 0UL);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFeStaticBlc", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetDynamicBadPxlCor(pMode, &GData.DynamicBadPixelCorrection);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDynamicBadPxlCor", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetCfaLeakageFilter(pMode, &GData.CfaLeakageFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCfaLeakageFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetCfaNoiseFilter(pMode, &GData.CfaNoiseFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCfaNoiseFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetAntiAliasing(pMode, &GData.AntiAliasing);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAntiAliasing", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetFeWbGain(pMode, &GData.FrontEndWbGain[0], 0UL);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFeWbGain", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetAfterCeWbGain(pMode, &GData.AfterCeWbGain);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAfterCeWbGain", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetBeforeCeWbGain(pMode, &GData.BeforeCeWbGain);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetBeforeCeWbGain", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetDemosaic(pMode, &GData.DemosaicFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDemosaic", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetGrgbMismatch(pMode, &GData.GbGrMismatch);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetGrgbMismatch", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetRgbTo12Y(pMode, &GData.RgbTo12Y);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetRgbTo12Y", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_Yuv2YuvExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetColorCorrection", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetToneCurve(pMode, &GData.ToneCurve);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetToneCurve", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetRgbToYuvMatrix(pMode, &GData.RgbToYuvMatrix);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetRgbToYuvMatrix", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetChromaScale(pMode, &GData.ChromaScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaScale", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetChromaMedianFilter(pMode, &GData.ChromaMedianFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaMedianFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetChromaFilter(pMode, &GData.ChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetWideChromaFilter(pMode, &GData.WideChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWideChromaFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetWideChromaFilterCombine(pMode, &GData.WideChromaFilterCombine);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWideChromaFilterCombine", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetLumaNoiseReduction(pMode, &GData.LumaNoiseReduction);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetLumaNoiseReduction", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetFirstLumaProcMode(pMode, &GData.FirstLumaProcessMode);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFirstLumaProcMode", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetAdvSpatFltr(pMode, &GData.AsfInfo.AsfInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetAdvSpatFltr", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_MctfExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsBoth", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsBothTdt(pMode, &GData.FinalSharpenBoth.ThreedTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsBothTdt", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsNoise(pMode, &GData.FinalSharpenNoise);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsNoise", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsFir(pMode, &GData.FinalFir);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsFir", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsCoring(pMode, &GData.FinalCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsCoring", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsCorIdxScl(pMode, &GData.FinalCoringIndexScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsCorIdxScl", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsMinCorRst(pMode, &GData.FinalMinCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsMinCorRst", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsMaxCorRst(pMode, &GData.FinalMaxCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsMaxCorRst", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsSclCor(pMode, &GData.FinalScaleCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsSclCor", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetVideoMctf(pMode, &GData.VideoMctf);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctf", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetVideoMctfTa(pMode, &GData.VideoMctfTemporalAdjust);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctfTa", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetVideoMctfAndFnlshp(pMode, &GData.VideoMctfAndFinalSharpen);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctfAndFnlshp", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}

static void _GData_Raw2yuvCalibExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    UINT32 rval = 0u;
    AMBA_IK_WARP_INFO_s DummyWarpInfo = {0};
    static AMBA_IK_GRID_POINT_s DummyTbl[4] = {0};
    DummyWarpInfo.Version = IK_WARP_VER;
    DummyWarpInfo.HorGridNum = 2;
    DummyWarpInfo.VerGridNum = 2;
    DummyWarpInfo.TileWidthExp = 3;
    DummyWarpInfo.TileHeightExp = 3;
    DummyWarpInfo.VinSensorGeo.StartX = 0;
    DummyWarpInfo.VinSensorGeo.StartY = 0;
    DummyWarpInfo.VinSensorGeo.Width = 8;
    DummyWarpInfo.VinSensorGeo.Height = 8;
    DummyWarpInfo.VinSensorGeo.HSubSample.FactorNum = 1;
    DummyWarpInfo.VinSensorGeo.HSubSample.FactorDen = 1;
    DummyWarpInfo.VinSensorGeo.VSubSample.FactorNum = 1;
    DummyWarpInfo.VinSensorGeo.VSubSample.FactorDen = 1;
    DummyWarpInfo.pWarp = DummyTbl;

    rval= AmbaIK_SetVinActiveWin(pMode, &GData.Active);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVinActiveWin", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetDummyMarginRange(pMode, &GData.Dummy);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDummyMarginRange", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetDzoomInfo(pMode, &GData.Dzoom);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDzoomInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetStaticBadPxlCorEnb(pMode, GData.StaticBadPixelCorrection.Enable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetStaticBadPxlCorEnb", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetVignetteEnb(pMode, GData.VignetteCompensation.Enable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVignetteEnb", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetCawarpEnb(pMode, (UINT32)GData.ChromaAberrationInfo.Enable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCawarpEnb", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetWarpEnb(pMode, 0);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWarpEnb", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_SetWarpInfo(pMode, &DummyWarpInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWarpInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_CeExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCe", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetCeInputTable(pMode, &GData.ContrastEnhance.ContrastEnhanceInputTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCeInputTable", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetCeOutputTable(pMode, &GData.ContrastEnhance.ContrastEnhanceOutTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetCeOutputTable", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_VideoHdrExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetHdrBlend", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_SetHdrRawOffset(pMode, &GData.VideoHdr.RawInfo.Offset);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetHdrRawOffset", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...
static void _GData_Execute(const AMBA_IK_MODE_CFG_s *pMode, AMBA_IK_ABILITY_s *pAbility)
{
    ...
    {
        pBinFile = fopen("../util/bin/ir_only20_gdata.bin", "rb");
...
static void _GData_SystemRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFlipMode", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...
#if 1
    {
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetAwbStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetAeStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetAfStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetPgAfStatInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetAfStatExInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetPgAfStatExInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetHistogramInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetPgHistogramInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...

    {
        ...
        LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetResampStrength", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...
static void _GData_RgbIrRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetRgbIr", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_Raw2RawRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFeToneCurve", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFeStaticBlc(pMode, &GDataGet.StaticBlackLevel[0], 0UL);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFeStaticBlc", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetDynamicBadPxlCor(pMode, &GDataGet.DynamicBadPixelCorrection);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetDynamicBadPxlCor", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetCfaLeakageFilter(pMode, &GDataGet.CfaLeakageFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetCfaLeakageFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetCfaNoiseFilter(pMode, &GDataGet.CfaNoiseFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetCfaNoiseFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetAntiAliasing(pMode, &GDataGet.AntiAliasing);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetAntiAliasing", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFeWbGain(pMode, &GDataGet.FrontEndWbGain[0], 0UL);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFeWbGain", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetAfterCeWbGain(pMode, &GDataGet.AfterCeWbGain);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetAfterCeWbGain", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetBeforeCeWbGain(pMode, &GDataGet.BeforeCeWbGain);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetBeforeCeWbGain", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetRgbTo12Y(pMode, &GDataGet.RgbTo12Y);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetRgbTo12Y", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetDemosaic(pMode, &GDataGet.DemosaicFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetDemosaic", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetGrgbMismatch(pMode, &GDataGet.GbGrMismatch);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetGrgbMismatch", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_Yuv2YuvRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetColorCorrection", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetToneCurve", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetRgbToYuvMatrix(pMode, &GDataGet.RgbToYuvMatrix);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetRgbToYuvMatrix", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetChromaScale(pMode, &GDataGet.ChromaScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetChromaScale", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetChromaMedianFilter(pMode, &GDataGet.ChromaMedianFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetChromaMedianFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetChromaFilter(pMode, &GDataGet.ChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetChromaFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetWideChromaFilter(pMode, &GDataGet.WideChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWideChromaFilter", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetWideChromaFilterCombine(pMode, &GDataGet.WideChromaFilterCombine);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWideChromaFilterCombine", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetLumaNoiseReduction(pMode, &GDataGet.LumaNoiseReduction);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetLumaNoiseReduction", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFirstLumaProcMode(pMode, &GDataGet.FirstLumaProcessMode);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFirstLumaProcMode", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetAdvSpatFltr(pMode, &GDataGet.AsfInfo.AsfInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetAdvSpatFltr", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_MctfRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsBoth", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsBothTdt(pMode, &GDataGet.FinalSharpenBoth.ThreedTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsBothTdt", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsNoise(pMode, &GDataGet.FinalSharpenNoise);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsNoise", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsFir(pMode, &GDataGet.FinalFir);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsFir", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsCoring(pMode, &GDataGet.FinalCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsCoring", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsCorIdxScl(pMode, &GDataGet.FinalCoringIndexScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsCorIdxScl", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsMinCorRst(pMode, &GDataGet.FinalMinCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsMinCorRst", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsMaxCorRst(pMode, &GDataGet.FinalMaxCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsMaxCorRst", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsSclCor(pMode, &GDataGet.FinalScaleCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsSclCor", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetVideoMctf(pMode, &GDataGet.VideoMctf);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVideoMctf", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetVideoMctfTa(pMode, &GDataGet.VideoMctfTemporalAdjust);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVideoMctfTa", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetVideoMctfAndFnlshp(pMode, &GDataGet.VideoMctfAndFinalSharpen);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVideoMctfAndFnlshp", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_Raw2yuvCalibRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVinActiveWin", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_GetDummyMarginRange(pMode, &GDataGet.Dummy);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetDummyMarginRange", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_GetDzoomInfo(pMode, &GDataGet.Dzoom);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetDzoomInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_GetWarpInfo(pMode, &GDataGet.WarpCompensationInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWarpInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    GDataGet.WarpCompensationInfo.pWarp = NULL; // hack the addresses to all 0, we don't compare memory addresses.
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetCawarpInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVignette", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetStaticBadPxlCor", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...
static void _GData_CeRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetCe", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetCeInputTable(pMode, &GDataGet.ContrastEnhance.ContrastEnhanceInputTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetCeInputTable", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetCeOutputTable(pMode, &GDataGet.ContrastEnhance.ContrastEnhanceOutTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetCeOutputTable", "OK case in ik_ctest_ir_only20.c", id_cnt++);
}
...
static void _GData_VideoHdrRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetHdrBlend", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval= AmbaIK_GetHdrRawOffset(pMode, &GDataGet.VideoHdr.RawInfo.Offset);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetHdrRawOffset", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    rval = AmbaIK_GetWindowSizeInfo(pMode, &WindowSizeInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWindowSizeInfo", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...
static void _GData_Refresh(const AMBA_IK_MODE_CFG_s *pMode, AMBA_IK_ABILITY_s *pAbility)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_GetContextAbility", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    ...
    {
        pBinFile = fopen("data/ik_ctest_ir_only20_gdata_get.bin", "wb");
...
INT32 ik_ctest_ir_only20_main(void)
{
    ...
    pFile = fopen("data/ik_ctest_ir_only20.txt", "w");
    ...
    LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitContext", "OK case in ik_ctest_ir_only20.c", id_cnt++);
    ...
    LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_ExecuteConfig", "OK case in ik_ctest_ir_only20.c", id_cnt++);

    {
        ...
        LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_QueryDebugConfigSize", "OK case in ik_ctest_ir_only20.c", id_cnt++);
        ...
        LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_DumpDebugConfig", "OK case in ik_ctest_ir_only20.c", id_cnt++);
...

        {
            ...
            fid = fopen("data/ik_ctest_ir_only20.bin", "wb");
