...
static void _Init_Image_Kernel(AMBA_IK_ABILITY_s *p_ability)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_QueryArchMemorySize", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_InitArch(&ContextSetting, (void*)ik_working_buffer, sizeof(ik_working_buffer));
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitArch", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_InitDefBinary(pBinDataAddr);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitDefBinary", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_InitCheckParamFunc();
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitCheckParamFunc", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetDebugLogId(255U, 1U);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_SetDebugLogId", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
}
...
static void _GData_SystemExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    _System.YuvMode = 0;//for 420 input

    rval = AmbaIK_GetWindowSizeInfo(pMode, &WindowSizeInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWindowSizeInfo", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWindowSizeInfo", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);

    rval= AmbaIK_SetYuvMode(pMode, _System.YuvMode);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetYuvMode", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);

    // Update Flip Info
    FlipInfo = 0UL;
    rval = AmbaIK_SetFlipMode(pMode, FlipInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFlipMode", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
...
static void _GData_Yuv2YuvExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetColorCorrection", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetToneCurve(pMode, &GData.ToneCurve);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetToneCurve", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetChromaScale(pMode, &GData.ChromaScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaScale", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetChromaMedianFilter(pMode, &GData.ChromaMedianFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaMedianFilter", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetChromaFilter(pMode, &GData.ChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetChromaFilter", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetWideChromaFilter(pMode, &GData.WideChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWideChromaFilter", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetWideChromaFilterCombine(pMode, &GData.WideChromaFilterCombine);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWideChromaFilterCombine", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetLumaNoiseReduction(pMode, &GData.LumaNoiseReduction);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetLumaNoiseReduction", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetFirstLumaProcMode(pMode, &GData.FirstLumaProcessMode);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFirstLumaProcMode", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);

    rval = AmbaIK_SetFstShpNsBoth(pMode, &GData.SharpenBoth.BothInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsBoth", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFstShpNsNoise(pMode, &GData.SharpenNoise);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsNoise", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFstShpNsFir(pMode, &GData.Fir);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsFir", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFstShpNsCoring(pMode, &GData.Coring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsCoring", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFstShpNsCorIdxScl(pMode, &GData.CoringIndexScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsCorIdxScl", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFstShpNsMinCorRst(pMode, &GData.MinCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsMinCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFstShpNsMaxCorRst(pMode, &GData.MaxCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsMaxCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFstShpNsSclCor(pMode, &GData.ScaleCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFstShpNsSclCor", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
}
...
static void _GData_MctfExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsBoth", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsBothTdt(pMode, &GData.FinalSharpenBoth.ThreedTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsBothTdt", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsNoise(pMode, &GData.FinalSharpenNoise);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsNoise", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsFir(pMode, &GData.FinalFir);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsFir", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsCoring(pMode, &GData.FinalCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsCoring", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsCorIdxScl(pMode, &GData.FinalCoringIndexScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsCorIdxScl", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsMinCorRst(pMode, &GData.FinalMinCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsMinCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsMaxCorRst(pMode, &GData.FinalMaxCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsMaxCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetFnlShpNsSclCor(pMode, &GData.FinalScaleCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetFnlShpNsSclCor", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetVideoMctf(pMode, &GData.VideoMctf);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctf", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetVideoMctfTa(pMode, &GData.VideoMctfTemporalAdjust);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctfTa", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_SetVideoMctfAndFnlshp(pMode, &GData.VideoMctfAndFinalSharpen);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVideoMctfAndFnlshp", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
}
...
static void _GData_Yuv2yuvCalibExecute(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetVinActiveWin", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetDzoomInfo(pMode, &GData.Dzoom);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetDzoomInfo", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_SetWarpEnb(pMode, 0);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_SetWarpEnb", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
}
...
static void _GData_Execute(const AMBA_IK_MODE_CFG_s *pMode, AMBA_IK_ABILITY_s *pAbility)
{
    ...
    {
        pBinFile = fopen("../util/bin/y2y420_cc_gdata.bin", "rb");
...
static void _GData_SystemRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFlipMode", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    fprintf(pFile, "FlipInfo = %d\r\n", FlipInfo);

    rval = AmbaIK_GetYuvMode(pMode, &YuvMode);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetYuvMode", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
...
static void _GData_Yuv2YuvRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetToneCurve", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetChromaScale(pMode, &GDataGet.ChromaScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetChromaScale", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetChromaMedianFilter(pMode, &GDataGet.ChromaMedianFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetChromaMedianFilter", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetChromaFilter(pMode, &GDataGet.ChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetChromaFilter", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetWideChromaFilter(pMode, &GDataGet.WideChromaFilter);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWideChromaFilter", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetWideChromaFilterCombine(pMode, &GDataGet.WideChromaFilterCombine);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWideChromaFilterCombine", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetLumaNoiseReduction(pMode, &GDataGet.LumaNoiseReduction);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetLumaNoiseReduction", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFirstLumaProcMode(pMode, &GDataGet.FirstLumaProcessMode);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFirstLumaProcMode", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsBoth(pMode, &GDataGet.SharpenBoth.BothInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsBoth", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsNoise(pMode, &GDataGet.SharpenNoise);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsNoise", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsFir(pMode, &GDataGet.Fir);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsFir", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsCoring(pMode, &GDataGet.Coring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsCoring", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsCorIdxScl(pMode, &GDataGet.CoringIndexScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsCorIdxScl", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsMinCorRst(pMode, &GDataGet.MinCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsMinCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsMaxCorRst(pMode, &GDataGet.MaxCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsMaxCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFstShpNsSclCor(pMode, &GDataGet.ScaleCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFstShpNsSclCor", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
}
...
static void _GData_MctfRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsBoth", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsBothTdt(pMode, &GDataGet.FinalSharpenBoth.ThreedTable);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsBothTdt", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsNoise(pMode, &GDataGet.FinalSharpenNoise);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsNoise", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsFir(pMode, &GDataGet.FinalFir);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsFir", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsCoring(pMode, &GDataGet.FinalCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsCoring", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsCorIdxScl(pMode, &GDataGet.FinalCoringIndexScale);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsCorIdxScl", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsMinCorRst(pMode, &GDataGet.FinalMinCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsMinCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsMaxCorRst(pMode, &GDataGet.FinalMaxCoringResult);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsMaxCorRst", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetFnlShpNsSclCor(pMode, &GDataGet.FinalScaleCoring);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetFnlShpNsSclCor", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetVideoMctf(pMode, &GDataGet.VideoMctf);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVideoMctf", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetVideoMctfTa(pMode, &GDataGet.VideoMctfTemporalAdjust);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVideoMctfTa", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval = AmbaIK_GetVideoMctfAndFnlshp(pMode, &GDataGet.VideoMctfAndFinalSharpen);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVideoMctfAndFnlshp", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
}
...
static void _GData_Yuv2yuvCalibRefresh(const AMBA_IK_MODE_CFG_s *pMode)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetVinActiveWin", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    rval= AmbaIK_GetDzoomInfo(pMode, &GDataGet.Dzoom);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetDzoomInfo", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);

    rval= AmbaIK_GetWarpInfo(pMode, &GDataGet.WarpCompensationInfo);
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageFilters.c", "AmbaIK_GetWarpInfo", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
...
static void _GData_Refresh(const AMBA_IK_MODE_CFG_s *pMode, AMBA_IK_ABILITY_s *pAbility)
{
    ...
    LOG_RVAL(pFile, rval, "AmbaDSP_ImageUtility.c", "AmbaIK_GetContextAbility", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
    ...
    {
        pBinFile = fopen("data/ik_ctest_y2y420_cc_gdata_get.bin", "wb");
...
INT32 ik_ctest_y2y420_cc_main(void)
{
    ...
    pFile = fopen("data/ik_ctest_y2y420_cc.txt", "w");
    ...
    LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_InitContext", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);

    // test set
    _GData_Execute(&Mode, &Ability);

    Rval |= AmbaIK_ExecuteConfig(&Mode, &ExecuteContainer);
    LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_ExecuteConfig", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);

    {
        ...
        LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_QueryDebugConfigSize", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
        ...
        LOG_RVAL(pFile, Rval, "AmbaDSP_ImageUtility.c", "AmbaIK_DumpDebugConfig", "OK case in ik_ctest_y2y420_cc.c", id_cnt++);
...

        {
            ...
            fid = fopen("data/ik_ctest_y2y420_cc.bin", "wb");
...
#if 0
        {
            ...
            fid = fopen("data/ik_ctest_y2y420_cc_sec2.bin", "wb");
