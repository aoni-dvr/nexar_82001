...
define PINFO
PINFO DESCRIPTION=SPINOR engine driver
endef

ifndef USEFILE
USEFILE=$(PROJECT_ROOT)/spinor.use
endif
...
EXTRA_INCVPATH += $(PROJECT_ROOT)/../../../src/$(AMBA_CHIP_ID)/inc/qnx_public/hw

LIBS +=  drvrS wrap_stdS m kal-ambarella io-utility io-mw

NAME=spinor-ambarella
