...
#define SDIO_CMD_RETRIES                1
#define SDIO_RESET_RETRIES                1
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/sdiodi/internal.h $ $Rev: 886103 $")
#endif
