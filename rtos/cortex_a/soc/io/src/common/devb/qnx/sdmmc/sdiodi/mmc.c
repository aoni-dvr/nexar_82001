...
int _mmc_switch( sdio_dev_t *dev, uint32_t cmdset, uint32_t mode, uint32_t index, uint32_t value, uint32_t timeout, uint32_t wrdy )
{
    sdio_cmd_t        *cmd;
    int                status;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/sdiodi/mmc.c $ $Rev: 892475 $")
#endif
