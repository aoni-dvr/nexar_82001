...
int sdio_pci_enable( sdio_hc_t *hc, int cap, int max_driver_supported_interrupts )
{
    sdio_hc_cfg_t    *cfg;
    sdio_pci_dev_t    *pci;
    int                idx;
...
int sdio_pci_capabilities( sdio_hc_t *hc )
{
    sdio_pci_dev_t    *pci;
    int                idx;
    pci_err_t        pci_err;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/sdiodi/pci.c $ $Rev: 879253 $")
#endif
