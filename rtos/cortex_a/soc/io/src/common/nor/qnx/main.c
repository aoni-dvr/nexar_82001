...
#if defined (CONFIG_SOC_CV2FS)|| defined (CONFIG_SOC_CV22FS)
    (void)AmbaINT_Disable(AMBA_INT_SPI_ID109_SPI_NOR);
    (void)AmbaINT_Config(AMBA_INT_SPI_ID109_SPI_NOR, &IntConfig, AmbaSPINOR_TransDoneSet, 0U);
    (void)AmbaINT_Enable(AMBA_INT_SPI_ID109_SPI_NOR);
#else
