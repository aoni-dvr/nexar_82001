 ...
 */
uint8_t *f3s_qspi_page(f3s_socket_t *socket, uint32_t flags, uint32_t offset,
                       int32_t *size)
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/flash/boards/qspi-xzynq/f3s_qspi_page.c $ $Rev: 859471 $");
#endif
