...
int clk_dev_init(clk_dev_t* cinfo)
{
    ...
    virt_base = mmap_device_io(0x1000, AMBA_CORC_BASE_ADDR);
...
int clk_dev_dinit(clk_dev_t* cinfo)
{
    ...
    munmap_device_io(AMBA_CORC_BASE_ADDR, 0x1000);
...
int Amba_Clk_Set_Pll_Freq(pll_id_t srcsel, UINT32 freq)
{
    ...
    case AMBA_PLL_SENSOR2:
        ...
        break;
    case AMBA_PLL_VIDEO2:
        AmbaRTSL_PllSetVoutLcdClk(freq);
        break;
    case AMBA_PLL_VISION:
...
unsigned int Amba_Clk_Get_Pll_Freq(pll_id_t srcsel)
{
    ...
    case AMBA_PLL_CORE:
        ...
        break;
    case AMBA_PLL_CORTEX:
        clock = AmbaRTSL_PllGetCortexClk();
        break;
    case AMBA_PLL_DDR:
    ...
    case AMBA_PLL_FEX:
        ...
        break;
    case AMBA_PLL_HDMI:
        clock = AmbaRTSL_PllGetVoutTvClk();
        break;
    case AMBA_PLL_HDMI2:
        clock = AmbaRTSL_PllGetPllOutFreq(AMBA_PLL_HDMI2);
        break;
    case AMBA_PLL_IDSP:
    ...
    case AMBA_PLL_SENSOR2:
        ...
        break;
    case AMBA_PLL_VIDEO2:
        clock = AmbaRTSL_PllGetVoutLcdClk();
        break;
    case AMBA_PLL_VISION:
