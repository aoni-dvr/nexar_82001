...
#define DCMD_CLOCK_CONFIG_VOUT            __DIOT(_DCMD_CLOCK, 14, vout_config_t)
#define DCMD_CLOCK_GET_RESET_ST           __DIOTF(_DCMD_CLOCK, 15, clk_reset_info_t)
