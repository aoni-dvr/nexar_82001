...
#define DCMD_SDMMC_RESET                __DIOF( _DCMD_CAM, _SIM_SDMMC + 15, struct _sdmmc_device_info)
#define DCMD_SDMMC_SET_CONFIG            __DIOT( _DCMD_CAM, _SIM_SDMMC + 16, AMBA_SD_SETTING_s)
#define DCMD_SDMMC_IOSTAT_INFO            __DIOTF( _DCMD_CAM, _SIM_SDMMC + 17,  io_statistics_t)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/devb/sdmmc/public/hw/dcmd_sim_sdmmc.h $ $Rev: 886103 $")
#endif
