...
#include <hw/ambarella_cehu.h>

#define AmbaMisra_TouchUnused(x)
#define AmbaMisra_TypeCast32(a, b) memcpy((void *)a, (void *)b, 4)

#define AMBA_CEHU0_BASE_ADDR                      0xE0025000
#define AMBA_CEHU1_BASE_ADDR                      0xE0026000

#define AMBA_CEHU0_MMAP_SIZE                      0x1000
#define AMBA_CEHU1_MMAP_SIZE                      0x1000

int cehu_dev_init(void);
int cehu_io_devctl(resmgr_context_t *ctp, io_devctl_t *msg, RESMGR_OCB_T *ocb);
int cehu_io_read(resmgr_context_t *ctp, io_read_t *msg, RESMGR_OCB_T *ocb);
