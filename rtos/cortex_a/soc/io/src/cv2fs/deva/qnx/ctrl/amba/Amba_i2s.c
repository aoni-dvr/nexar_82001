...
int Amba_I2s_Init(void)
{
    ...
    (void)AmbaGPIO_SetFuncAlt(GPIO_PIN_021_I2S0_CLK);
    (void)AmbaGPIO_SetFuncAlt(GPIO_PIN_022_I2S0_SI_0);
    (void)AmbaGPIO_SetFuncAlt(GPIO_PIN_023_I2S0_SO_0);
    (void)AmbaGPIO_SetFuncAlt(GPIO_PIN_026_I2S0_WS);
