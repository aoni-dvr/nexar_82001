...
#define AMBA_SCRATCHPAD_NS_BASE_ADDR           AMBA_CA53_SCRATCHPAD_NS_BASE_ADDR
#define AMBA_USB_BASE_ADDR                     AMBA_CA53_USB_BASE_ADDR
#define AMBA_RCT_MMAP_SIZE                     0x00001000
#define AMBA_SCRATCHPAD_S_MMAP_SIZE            0x00000100
#define AMBA_SCRATCHPAD_NS_MMAP_SIZE           0x00000300
