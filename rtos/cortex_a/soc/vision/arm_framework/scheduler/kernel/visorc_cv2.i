...
#ifndef VISORC_CV2_I_FILE
#define VISORC_CV2_I_FILE
...
uint32_t krn_visorc_init(void)
{
    ...
    krn_module_printU5("[AMBACV] TARGET CHIP   :   CV2 \n",0U,0U,0U,0U,0U);
    return retcode;
}
...
uint32_t krn_visorc_start(uint32_t flag, visorc_init_params_t *sysconfig)
{
    ...
    if(sysconfig == NULL) {
        ...
        krn_writel_relaxed(0x00000780U, visorc_reg(CLUSTER_SRESET));
        krn_writel_relaxed(0x00000000U, visorc_reg(CLUSTER_SRESET));
