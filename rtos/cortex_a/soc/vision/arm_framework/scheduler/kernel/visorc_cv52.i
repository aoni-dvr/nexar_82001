...
#ifndef VISORC_CV52_I_FILE
#define VISORC_CV52_I_FILE
...
#define VISORC_BASE     0x20ed000000UL
#define VISORC_SIZE     0x0001000000UL
...
/* for RCT */
#define CLUSTER_SRESET  0x0d0228U
...
uint32_t krn_visorc_init(void)
{
    ...
    krn_module_printU5("[AMBACV] TARGET CHIP   :   CV52 \n",0U,0U,0U,0U,0U);
    return retcode;
}
...
uint32_t krn_visorc_start(uint32_t flag, visorc_init_params_t *sysconfig)
{
    ...
    if(sysconfig == NULL) {
        ...
        krn_writel_relaxed(0x00000300U, visorc_reg(CLUSTER_SRESET));
        krn_writel_relaxed(0x00000000U, visorc_reg(CLUSTER_SRESET));
