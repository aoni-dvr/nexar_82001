...
#gcovr ../obj -r ${ROOT_DIR}/vendors/ambarella/wrapper/usb --exclude-unreachable-branches --json -o run_003.json
...
## generate json report for main_003.exe
#gcovr ../obj -r ${ROOT_DIR}/vendors/ambarella/wrapper/usb --exclude-unreachable-branches --json -o run_004.json
