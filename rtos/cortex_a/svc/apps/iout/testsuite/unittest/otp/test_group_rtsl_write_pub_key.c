...
#define TEST_CASE_STR "rtsl_otp_write_public_key"

static void test_fail_001(void)
{
    UINT32 uret;

    uret = AmbaRTSL_OtpPublicKeyWrite(NULL, 512, 0);
...
static void test_fail_002(void)
{
    ...
    uret = AmbaRTSL_OtpPublicKeyWrite(buffer, 100, 0);
...
static void test_fail_003(void)
{
    ...
    uret = AmbaRTSL_OtpPublicKeyWrite(buffer, 512, 100);
