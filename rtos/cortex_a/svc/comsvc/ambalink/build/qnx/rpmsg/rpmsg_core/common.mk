...
# Dump backtrace, uncomment to enable
#DUMP_BACKTRACE := y
...
CCFLAGS += -Werror
#OPTIMIZE_TYPE = amba
#OPTIMIZE_amba_gcc = -O0 -g -ggdb
ifdef DUMP_BACKTRACE
CCFLAGS += -DDUMP_BACKTRACE
endif
...
LIBS += c m socket
LIBS += wrap_std kal-ambarella
LIBS += comsvc-ambarella-print comsvc-ambarella-misc
LIBS += io-utility
ifdef DUMP_BACKTRACE
LIBS += backtrace
endif
