...
EXTRA_INCVPATH += $(PROJECT_ROOT)/../../stream
EXTRA_INCVPATH += $(srctree)/svc/comsvc/codec/inc
EXTRA_INCVPATH += $(PROJECT_ROOT)/../../../fifo/inc
EXTRA_INCVPATH += $(PROJECT_ROOT)/../../../container/inc
...
#
define PINFO
PINFO DESCRIPTION="ambarella codec wrapper for comsvc libraries (partially.)"
endef
