...
typedef struct {
    uint32_t GainRO; //original gain
    uint32_t GainGO;
    uint32_t GainBO;
    uint32_t GainR;  //redunant result
    uint32_t GainG;
    uint32_t GainB;
    uint32_t CmpResult; //0:not equal
...
//AE
    ...
    int32_t   PreDgain;
//ADJ
    ADJ_FLEXDIAG_GROUP0_s ADJGROUP0;
    ADJ_FLEXDIAG_GROUP1_s* ADJGROUP1;
    uint32_t *pUINT32Array;
    int32_t  *pINT32Array;
    AMBA_IK_COLOR_CORRECTION_s *pCC0;
    AMBA_IK_COLOR_CORRECTION_s *pCC1;
    AMBA_IK_COLOR_CORRECTION_s *pCC2;
