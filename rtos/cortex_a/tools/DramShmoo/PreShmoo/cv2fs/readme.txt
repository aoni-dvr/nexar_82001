...
*.ini:
    ...
    Notice that for CV2x/H32, the DDRC_DQ_READ_DELAY in .ini need to include the enable bit setting.
        To have the read delay value as Y, the value of "(Y*2)+1" need to be specified in .ini.
        Please refer to the description of DDRC_DQ_READ_DELAY in bstiniparser.txt.