...
dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m pad-term
rem    dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m pad-term --pad-term-start 4 --pad-term-end 6
rem    dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m pad-term=4,1,6
dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m pad-dds
dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m pad-vref
dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m rddly
dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m wrdly
rem    dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m wrdly --wrdly-start 40 -- wrdly-end 47
rem d:\temp\work\pre_shmoo\cv2x>cv25_bub_lpddr4_1die_2g_1200.bat
rem 
...
rem   53: 1
rem 
rem start:21:03:08.99
rem end:  21:03:23.47


rem dram_preliminary_shmoo.exe -n cv25 -a cv25_bub_lpddr4_1die_2g_1200.ads -m pad-term -m pad-dds -m pad-vref -m rddly -m wrdly --pad-term-start 3 --pad-term-end 5 --pad-dds-start 6 --pad-vref-start 16 --pad-vref-step 4 --pad-vref-end 36 --rddly-end 80 --wrdly-start 160 --wrdly-end 240 --rddly-step 6 --wrdly-step 6
