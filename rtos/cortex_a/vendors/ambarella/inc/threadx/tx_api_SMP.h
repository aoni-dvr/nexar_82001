...
} __attribute__((aligned(4), packed)) TX_THREAD;
...
/* add this variable to support executing RTOS on core1/core2/core3 */
/* it is added by AMBA */
VOID        _tx_initilaize_rtos_core_id(UINT CoreId);
extern UINT _tx_rtos_core_id;

#define TX_SMP_CORE_ID                          (_tx_thread_smp_core_get() - _tx_rtos_core_id)
