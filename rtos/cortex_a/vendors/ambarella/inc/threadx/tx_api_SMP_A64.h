...
/*                                            version 5.6.2               */
/*  09-01-2015     William E. Lamie         Modified comment(s), modified */
/*                                            code for ThreadX 5.7        */
/*                                            compatibility, added default*/
/*                                            for port-specific memory    */
...
/*                                            version 5.7                 */
/*  04-01-2016     William E. Lamie         Modified comment(s), added    */
/*                                            core excluded/allowed       */
/*                                            members to the TX_THREAD    */
/*                                            structure, and changed      */
/*                                            member name control to      */
/*                                            excluded for internal timer */
/*                                            struct, resulting in        */
/*                                            version 5.7.1               */
/*  08-03-2016     William E. Lamie         Modified comment(s), corrected*/
...
#define TX_NO_WAIT                      ((UINT32)  0)
#define TX_WAIT_FOREVER                 ((UINT32)  0xFFFFFFFFUL)
...
#define TX_NO_TIME_SLICE                ((UINT32)  0)
...
#define TX_EMPTY                        ((UINT32)  0)
#define TX_CLEAR_ID                     ((UINT32)  0)
#define TX_STACK_FILL                   ((UINT32)  0xEFEFEFEFUL)
...
#define TX_TIMER_TICKS_PER_SECOND       ((UINT32) 100)
#endif
...
typedef struct TX_TIMER_INTERNAL_STRUCT
{
    ...
    UINT32               tx_timer_internal_remaining_ticks;
    UINT32               tx_timer_internal_re_initialize_ticks;

    /* Define the timeout function and timeout function parameter.  */
    VOID                (*tx_timer_internal_timeout_function)(UINT32 id);
    UINT32               tx_timer_internal_timeout_param;
    ...
    UINT32               tx_timer_internal_smp_cores_excluded;
...
typedef struct TX_TIMER_STRUCT
{
    ...
    UINT32               tx_timer_performance_activate_count;

    /* Define the number of timer reactivations.  */
    UINT32               tx_timer_performance_reactivate_count;

    /* Define the number of timer deactivations.  */
    UINT32               tx_timer_performance_deactivate_count;

    /* Define the number of timer expirations.  */
    UINT32               tx_timer_performance_expiration_count;

    /* Define the total number of timer expiration adjustments.  */
    UINT32               tx_timer_performance__expiration_adjust_count;
#endif
...
typedef struct TX_THREAD_STRUCT
{
    ...
    UINT32               tx_thread_id;                   /* Control block ID         */
    UINT32               tx_thread_run_count;            /* Thread's run counter     */
    ...
    UINT32               tx_thread_stack_size;           /* Stack size               */
    UINT32               tx_thread_time_slice;           /* Current time-slice       */
    UINT32               tx_thread_new_time_slice;       /* New time-slice           */
    ...
    VOID                (*tx_thread_schedule_hook)(struct TX_THREAD_STRUCT *thread_ptr, UINT32 id);
    ...
    UINT32               tx_thread_entry_parameter;
    ...
    /* Define the thread's cleanup function and associated data.  This
       ...
       a timeout.  */
    VOID                (*tx_thread_suspend_cleanup)(struct TX_THREAD_STRUCT *thread_ptr, UINT32 suspension_sequence);
    VOID                *tx_thread_suspend_control_block;
    struct TX_THREAD_STRUCT
                        *tx_thread_suspended_next,
                        *tx_thread_suspended_previous;
    UINT32               tx_thread_suspend_info;
    ...
    UINT32               tx_thread_smp_core_control;
    ...
    UINT32               tx_thread_smp_cores_excluded;
    UINT32               tx_thread_smp_cores_allowed;
    UINT32               tx_thread_smp_lock_ready_bit;
    ...
    UINT32               tx_thread_suspension_sequence;
...
typedef struct TX_BLOCK_POOL_STRUCT
{
    ...
    UINT32               tx_block_pool_performance_allocate_count;

    /* Define the number of block releases.  */
    UINT32               tx_block_pool_performance_release_count;

    /* Define the number of block pool suspensions.  */
    UINT32               tx_block_pool_performance_suspension_count;

    /* Define the number of block pool timeouts.  */
    UINT32               tx_block_pool_performance_timeout_count;
#endif
...
typedef struct TX_BYTE_POOL_STRUCT
{
    ...
    UINT32               tx_byte_pool_performance_allocate_count;

    /* Define the number of releases.  */
    UINT32               tx_byte_pool_performance_release_count;

    /* Define the number of adjacent memory fragment merges.  */
    UINT32               tx_byte_pool_performance_merge_count;

    /* Define the number of memory fragment splits.  */
    UINT32               tx_byte_pool_performance_split_count;

    /* Define the number of memory fragments searched that either were not free or could not satisfy the
       request.  */
    UINT32               tx_byte_pool_performance_search_count;

    /* Define the number of byte pool suspensions.  */
    UINT32               tx_byte_pool_performance_suspension_count;

    /* Define the number of byte pool timeouts.  */
    UINT32               tx_byte_pool_performance_timeout_count;
#endif
...
typedef struct TX_EVENT_FLAGS_GROUP_STRUCT
{
    ...
    UINT32               tx_event_flags_group_id;
    ...
    UINT32               tx_event_flags_group_current;
    ...
    UINT32               tx_event_flags_group_delayed_clear;

#ifdef TX_EVENT_FLAGS_ENABLE_PERFORMANCE_INFO

    /* Define the number of event flag sets.  */
    UINT32               tx_event_flags_group_performance_set_count;

    /* Define the number of event flag gets.  */
    UINT32               tx_event_flags_group__performance_get_count;

    /* Define the number of event flag suspensions.  */
    UINT32               tx_event_flags_group___performance_suspension_count;

    /* Define the number of event flag timeouts.  */
    UINT32               tx_event_flags_group____performance_timeout_count;
#endif
...
typedef struct TX_MUTEX_STRUCT
{
    ...
    UINT32               tx_mutex_performance_put_count;

    /* Define the total number of mutex gets.  */
    UINT32               tx_mutex_performance_get_count;

    /* Define the total number of mutex suspensions.  */
    UINT32               tx_mutex_performance_suspension_count;

    /* Define the total number of mutex timeouts.  */
    UINT32               tx_mutex_performance_timeout_count;

    /* Define the total number of priority inversions.  */
    UINT32               tx_mutex_performance_priority_inversion_count;

    /* Define the total number of priority inheritance conditions.  */
    UINT32               tx_mutex_performance__priority_inheritance_count;
#endif
...
typedef struct TX_SEMAPHORE_STRUCT
{
    ...
    UINT32               tx_semaphore_performance_put_count;

    /* Define the number of semaphore gets.  */
    UINT32               tx_semaphore_performance_get_count;

    /* Define the number of semaphore suspensions.  */
    UINT32               tx_semaphore_performance_suspension_count;

    /* Define the number of semaphore timeouts.  */
    UINT32               tx_semaphore_performance_timeout_count;
#endif
...
#if !defined(AMBA_KAL_H) || defined(AMBA_KAL_SOURCE_CODE) || defined(UX_SOURCE_CODE)
...
#ifndef TX_SOURCE_CODE
extern UINT32 volatile  _tx_timer_system_clock;
#endif
#endif
...
UINT        _tx_thread_smp_core_exclude(TX_THREAD *thread_ptr, UINT32 exclusion_map);
UINT        _tx_thread_smp_core_exclude_get(TX_THREAD *thread_ptr, UINT32 *exclusion_map_ptr);
UINT        _tx_thread_smp_core_get(void);
UINT        _tx_timer_smp_core_exclude(TX_TIMER *timer_ptr, UINT32 exclusion_map);
UINT        _tx_timer_smp_core_exclude_get(TX_TIMER *timer_ptr, UINT32 *exclusion_map_ptr);
...
UINT32       _tx_thread_smp_current_state_get(void);
UINT32       _tx_thread_smp_time_get(void);
...
void        _tx_thread_smp_debug_entry_insert(UINT32 id, UINT32 suspend, VOID *thread_ptr);
#endif
...
UINT        _tx_block_allocate(TX_BLOCK_POOL *pool_ptr, VOID **block_ptr, UINT32 wait_option);
UINT        _tx_block_pool_create(TX_BLOCK_POOL *pool_ptr, CHAR *name_ptr, UINT32 block_size,
                    VOID *pool_start, UINT32 pool_size);
UINT        _tx_block_pool_delete(TX_BLOCK_POOL *pool_ptr);
UINT        _tx_block_pool_info_get(TX_BLOCK_POOL *pool_ptr, CHAR **name, UINT32 *available_blocks,
                    UINT32 *total_blocks, TX_THREAD **first_suspended,
                    UINT32 *suspended_count, TX_BLOCK_POOL **next_pool);
UINT        _tx_block_pool_performance_info_get(TX_BLOCK_POOL *pool_ptr, UINT32 *allocates, UINT32 *releases,
                    UINT32 *suspensions, UINT32 *timeouts);
UINT        _tx_block_pool_performance_system_info_get(UINT32 *allocates, UINT32 *releases,
                    UINT32 *suspensions, UINT32 *timeouts);
...
UINT        _txe_block_allocate(TX_BLOCK_POOL *pool_ptr, VOID **block_ptr, UINT32 wait_option);
UINT        _txe_block_pool_create(TX_BLOCK_POOL *pool_ptr, CHAR *name_ptr, UINT32 block_size,
                    VOID *pool_start, UINT32 pool_size, UINT pool_control_block_size);
UINT        _txe_block_pool_delete(TX_BLOCK_POOL *pool_ptr);
UINT        _txe_block_pool_info_get(TX_BLOCK_POOL *pool_ptr, CHAR **name, UINT32 *available_blocks,
                    UINT32 *total_blocks, TX_THREAD **first_suspended,
                    UINT32 *suspended_count, TX_BLOCK_POOL **next_pool);
...
UINT        _tx_byte_allocate(TX_BYTE_POOL *pool_ptr, VOID **memory_ptr, UINT32 memory_size,
                    UINT32 wait_option);
...
UINT        _tx_byte_pool_info_get(TX_BYTE_POOL *pool_ptr, CHAR **name, UINT32 *available_bytes,
                    UINT32 *fragments, TX_THREAD **first_suspended,
                    UINT32 *suspended_count, TX_BYTE_POOL **next_pool);
UINT        _tx_byte_pool_performance_info_get(TX_BYTE_POOL *pool_ptr, UINT32 *allocates, UINT32 *releases,
                    UINT32 *fragments_searched, UINT32 *merges, UINT32 *splits, UINT32 *suspensions, UINT32 *timeouts);
UINT        _tx_byte_pool_performance_system_info_get(UINT32 *allocates, UINT32 *releases,
                    UINT32 *fragments_searched, UINT32 *merges, UINT32 *splits, UINT32 *suspensions, UINT32 *timeouts);
...
UINT        _txe_byte_allocate(TX_BYTE_POOL *pool_ptr, VOID **memory_ptr, UINT32 memory_size,
                    UINT32 wait_option);
UINT        _txe_byte_pool_create(TX_BYTE_POOL *pool_ptr, CHAR *name_ptr, VOID *pool_start,
                    UINT32 pool_size, UINT pool_control_block_size);
UINT        _txe_byte_pool_delete(TX_BYTE_POOL *pool_ptr);
UINT        _txe_byte_pool_info_get(TX_BYTE_POOL *pool_ptr, CHAR **name, UINT32 *available_bytes,
                    UINT32 *fragments, TX_THREAD **first_suspended,
                    UINT32 *suspended_count, TX_BYTE_POOL **next_pool);
...
UINT        _tx_event_flags_get(TX_EVENT_FLAGS_GROUP *group_ptr, UINT32 requested_flags,
                    UINT get_option, UINT32 *actual_flags_ptr, UINT32 wait_option);
UINT        _tx_event_flags_info_get(TX_EVENT_FLAGS_GROUP *group_ptr, CHAR **name, UINT32 *current_flags,
                    TX_THREAD **first_suspended, UINT32 *suspended_count,
                    TX_EVENT_FLAGS_GROUP **next_group);
UINT        _tx_event_flags_performance_info_get(TX_EVENT_FLAGS_GROUP *group_ptr, UINT32 *sets, UINT32 *gets,
                    UINT32 *suspensions, UINT32 *timeouts);
UINT        _tx_event_flags_performance_system_info_get(UINT32 *sets, UINT32 *gets,
                    UINT32 *suspensions, UINT32 *timeouts);
UINT        _tx_event_flags_set(TX_EVENT_FLAGS_GROUP *group_ptr, UINT32 flags_to_set,
                    UINT set_option);
...
UINT        _txe_event_flags_get(TX_EVENT_FLAGS_GROUP *group_ptr, UINT32 requested_flags,
                    UINT get_option, UINT32 *actual_flags_ptr, UINT32 wait_option);
UINT        _txe_event_flags_info_get(TX_EVENT_FLAGS_GROUP *group_ptr, CHAR **name, UINT32 *current_flags,
                    TX_THREAD **first_suspended, UINT32 *suspended_count,
                    TX_EVENT_FLAGS_GROUP **next_group);
UINT        _txe_event_flags_set(TX_EVENT_FLAGS_GROUP *group_ptr, UINT32 flags_to_set,
                    UINT set_option);
...
UINT        _tx_mutex_get(TX_MUTEX *mutex_ptr, UINT32 wait_option);
UINT        _tx_mutex_info_get(TX_MUTEX *mutex_ptr, CHAR **name, UINT32 *count, TX_THREAD **owner,
                    TX_THREAD **first_suspended, UINT32 *suspended_count,
                    TX_MUTEX **next_mutex);
UINT        _tx_mutex_performance_info_get(TX_MUTEX *mutex_ptr, UINT32 *puts, UINT32 *gets,
                    UINT32 *suspensions, UINT32 *timeouts, UINT32 *inversions, UINT32 *inheritances);
UINT        _tx_mutex_performance_system_info_get(UINT32 *puts, UINT32 *gets, UINT32 *suspensions, UINT32 *timeouts,
                    UINT32 *inversions, UINT32 *inheritances);
...
UINT        _txe_mutex_get(TX_MUTEX *mutex_ptr, UINT32 wait_option);
UINT        _txe_mutex_info_get(TX_MUTEX *mutex_ptr, CHAR **name, UINT32 *count, TX_THREAD **owner,
                    TX_THREAD **first_suspended, UINT32 *suspended_count,
                    TX_MUTEX **next_mutex);
...
UINT        _tx_queue_create(TX_QUEUE *queue_ptr, CHAR *name_ptr, UINT message_size,
                        VOID *queue_start, UINT32 queue_size);
UINT        _tx_queue_delete(TX_QUEUE *queue_ptr);
UINT        _tx_queue_flush(TX_QUEUE *queue_ptr);
UINT        _tx_queue_info_get(TX_QUEUE *queue_ptr, CHAR **name, UINT32 *enqueued, UINT32 *available_storage,
                    TX_THREAD **first_suspended, UINT32 *suspended_count, TX_QUEUE **next_queue);
UINT        _tx_queue_performance_info_get(TX_QUEUE *queue_ptr, UINT32 *messages_sent, UINT32 *messages_received,
                    UINT32 *empty_suspensions, UINT32 *full_suspensions, UINT32 *full_errors, UINT32 *timeouts);
UINT        _tx_queue_performance_system_info_get(UINT32 *messages_sent, UINT32 *messages_received,
                    UINT32 *empty_suspensions, UINT32 *full_suspensions, UINT32 *full_errors, UINT32 *timeouts);
UINT        _tx_queue_prioritize(TX_QUEUE *queue_ptr);
UINT        _tx_queue_receive(TX_QUEUE *queue_ptr, VOID *destination_ptr, UINT32 wait_option);
UINT        _tx_queue_send(TX_QUEUE *queue_ptr, VOID *source_ptr, UINT32 wait_option);
UINT        _tx_queue_send_notify(TX_QUEUE *queue_ptr, VOID (*queue_send_notify)(TX_QUEUE *notify_queue_ptr));
UINT        _tx_queue_front_send(TX_QUEUE *queue_ptr, VOID *source_ptr, UINT32 wait_option);
...
UINT        _txe_queue_create(TX_QUEUE *queue_ptr, CHAR *name_ptr, UINT message_size,
                        VOID *queue_start, UINT32 queue_size, UINT queue_control_block_size);
UINT        _txe_queue_delete(TX_QUEUE *queue_ptr);
UINT        _txe_queue_flush(TX_QUEUE *queue_ptr);
UINT        _txe_queue_info_get(TX_QUEUE *queue_ptr, CHAR **name, UINT32 *enqueued, UINT32 *available_storage,
                    TX_THREAD **first_suspended, UINT32 *suspended_count, TX_QUEUE **next_queue);
UINT        _txe_queue_prioritize(TX_QUEUE *queue_ptr);
UINT        _txe_queue_receive(TX_QUEUE *queue_ptr, VOID *destination_ptr, UINT32 wait_option);
UINT        _txe_queue_send(TX_QUEUE *queue_ptr, VOID *source_ptr, UINT32 wait_option);
UINT        _txe_queue_send_notify(TX_QUEUE *queue_ptr, VOID (*queue_send_notify)(TX_QUEUE *notify_queue_ptr));
UINT        _txe_queue_front_send(TX_QUEUE *queue_ptr, VOID *source_ptr, UINT32 wait_option);


/* Define semaphore management function prototypes.  */

UINT        _tx_semaphore_ceiling_put(TX_SEMAPHORE *semaphore_ptr, UINT32 ceiling);
UINT        _tx_semaphore_create(TX_SEMAPHORE *semaphore_ptr, CHAR *name_ptr, UINT32 initial_count);
UINT        _tx_semaphore_delete(TX_SEMAPHORE *semaphore_ptr);
UINT        _tx_semaphore_get(TX_SEMAPHORE *semaphore_ptr, UINT32 wait_option);
UINT        _tx_semaphore_info_get(TX_SEMAPHORE *semaphore_ptr, CHAR **name, UINT32 *current_value,
                    TX_THREAD **first_suspended, UINT32 *suspended_count,
                    TX_SEMAPHORE **next_semaphore);
UINT        _tx_semaphore_performance_info_get(TX_SEMAPHORE *semaphore_ptr, UINT32 *puts, UINT32 *gets,
                    UINT32 *suspensions, UINT32 *timeouts);
UINT        _tx_semaphore_performance_system_info_get(UINT32 *puts, UINT32 *gets, UINT32 *suspensions, UINT32 *timeouts);
...
UINT        _txe_semaphore_ceiling_put(TX_SEMAPHORE *semaphore_ptr, UINT32 ceiling);
UINT        _txe_semaphore_create(TX_SEMAPHORE *semaphore_ptr, CHAR *name_ptr, UINT32 initial_count, UINT semaphore_control_block_size);
UINT        _txe_semaphore_delete(TX_SEMAPHORE *semaphore_ptr);
UINT        _txe_semaphore_get(TX_SEMAPHORE *semaphore_ptr, UINT32 wait_option);
UINT        _txe_semaphore_info_get(TX_SEMAPHORE *semaphore_ptr, CHAR **name, UINT32 *current_value,
                    TX_THREAD **first_suspended, UINT32 *suspended_count,
                    TX_SEMAPHORE **next_semaphore);
...
UINT        _tx_thread_create(TX_THREAD *thread_ptr, CHAR *name_ptr,
                ...
                VOID *stack_start, UINT32 stack_size,
                UINT priority, UINT preempt_threshold,
                UINT32 time_slice, UINT auto_start);
...
UINT        _tx_thread_info_get(TX_THREAD *thread_ptr, CHAR **name, UINT *state, UINT32 *run_count,
                UINT *priority, UINT *preemption_threshold, UINT32 *time_slice,
                TX_THREAD **next_thread, TX_THREAD **next_suspended_thread);
UINT        _tx_thread_interrupt_control(UINT new_posture);
UINT        _tx_thread_performance_info_get(TX_THREAD *thread_ptr, UINT32 *resumptions, UINT32 *suspensions,
                UINT32 *solicited_preemptions, UINT32 *interrupt_preemptions, UINT32 *priority_inversions,
                UINT32 *time_slices, UINT32 *relinquishes, UINT32 *timeouts, UINT32 *wait_aborts, TX_THREAD **last_preempted_by);
UINT        _tx_thread_performance_system_info_get(UINT32 *resumptions, UINT32 *suspensions,
                UINT32 *solicited_preemptions, UINT32 *interrupt_preemptions, UINT32 *priority_inversions,
                UINT32 *time_slices, UINT32 *relinquishes, UINT32 *timeouts, UINT32 *wait_aborts,
                UINT32 *non_idle_returns, UINT32 *idle_returns);
...
UINT        _tx_thread_sleep(UINT32 timer_ticks);
UINT        _tx_thread_stack_error_notify(VOID (*stack_error_handler)(TX_THREAD *thread_ptr));
UINT        _tx_thread_suspend(TX_THREAD *thread_ptr);
UINT        _tx_thread_terminate(TX_THREAD *thread_ptr);
UINT        _tx_thread_time_slice_change(TX_THREAD *thread_ptr, UINT32 new_time_slice, UINT32 *old_time_slice);
...
UINT        _txe_thread_create(TX_THREAD *thread_ptr, CHAR *name_ptr,
                ...
                VOID *stack_start, UINT32 stack_size,
                UINT priority, UINT preempt_threshold,
                UINT32 time_slice, UINT auto_start, UINT thread_control_block_size);
...
UINT        _txe_thread_info_get(TX_THREAD *thread_ptr, CHAR **name, UINT *state, UINT32 *run_count,
                UINT *priority, UINT *preemption_threshold, UINT32 *time_slice,
                TX_THREAD **next_thread, TX_THREAD **next_suspended_thread);
...
UINT        _txe_thread_time_slice_change(TX_THREAD *thread_ptr, UINT32 new_time_slice, UINT32 *old_time_slice);
...
UINT        _tx_timer_change(TX_TIMER *timer_ptr, UINT32 initial_ticks, UINT32 reschedule_ticks);
UINT        _tx_timer_create(TX_TIMER *timer_ptr, CHAR *name_ptr,
                VOID (*expiration_function)(UINT32 input), UINT32 expiration_input,
                UINT32 initial_ticks, UINT32 reschedule_ticks, UINT auto_activate);
UINT        _tx_timer_deactivate(TX_TIMER *timer_ptr);
UINT        _tx_timer_delete(TX_TIMER *timer_ptr);
UINT        _tx_timer_info_get(TX_TIMER *timer_ptr, CHAR **name, UINT *active, UINT32 *remaining_ticks,
                UINT32 *reschedule_ticks, TX_TIMER **next_timer);
UINT        _tx_timer_performance_info_get(TX_TIMER *timer_ptr, UINT32 *activates, UINT32 *reactivates,
                UINT32 *deactivates, UINT32 *expirations, UINT32 *expiration_adjusts);
UINT        _tx_timer_performance_system_info_get(UINT32 *activates, UINT32 *reactivates,
                UINT32 *deactivates, UINT32 *expirations, UINT32 *expiration_adjusts);

UINT32       _tx_time_get(VOID);
VOID        _tx_time_set(UINT32 new_time);
...
UINT        _txe_timer_change(TX_TIMER *timer_ptr, UINT32 initial_ticks, UINT32 reschedule_ticks);
UINT        _txe_timer_create(TX_TIMER *timer_ptr, CHAR *name_ptr,
                VOID (*expiration_function)(UINT32 input), UINT32 expiration_input,
                UINT32 initial_ticks, UINT32 reschedule_ticks, UINT auto_activate, UINT timer_control_block_size);
UINT        _txe_timer_deactivate(TX_TIMER *timer_ptr);
UINT        _txe_timer_delete(TX_TIMER *timer_ptr);
UINT        _txe_timer_info_get(TX_TIMER *timer_ptr, CHAR **name, UINT *active, UINT32 *remaining_ticks,
                UINT32 *reschedule_ticks, TX_TIMER **next_timer);


/* Define trace API function prototypes.  */

UINT        _tx_trace_enable(VOID *trace_buffer_start, UINT32 trace_buffer_size, UINT32 registry_entries);
UINT        _tx_trace_event_filter(UINT32 event_filter_bits);
UINT        _tx_trace_event_unfilter(UINT32 event_unfilter_bits);
UINT        _tx_trace_disable(VOID);
VOID        _tx_trace_isr_enter_insert(UINT32 isr_id);
VOID        _tx_trace_isr_exit_insert(UINT32 isr_id);
UINT        _tx_trace_buffer_full_notify(VOID (*full_buffer_callback)(VOID *buffer));
UINT        _tx_trace_user_event_insert(UINT32 event_id, UINT32 info_field_1, UINT32 info_field_2, UINT32 info_field_3, UINT32 info_field_4);
...
TX_TIMER_INTERNAL       **_tx_misra_timer_pointer_add(TX_TIMER_INTERNAL **ptr1, UINT32 size);
...
#define TX_UCHAR_POINTER_ADD(a,b)                       _tx_misra_uchar_pointer_add((UCHAR *) (a), (UINT32) (b))
#define TX_UCHAR_POINTER_SUB(a,b)                       _tx_misra_uchar_pointer_sub((UCHAR *) (a), (UINT32) (b))
#define TX_UCHAR_POINTER_DIF(a,b)                       _tx_misra_uchar_pointer_dif((UCHAR *) (a), (UCHAR *) (b))
#define TX_ULONG_POINTER_ADD(a,b)                       _tx_misra_ulong_pointer_add((UINT32 *) (a), (UINT32) (b))
#define TX_ULONG_POINTER_SUB(a,b)                       _tx_misra_ulong_pointer_sub((UINT32 *) (a), (UINT32) (b))
#define TX_ULONG_POINTER_DIF(a,b)                       _tx_misra_ulong_pointer_dif((UINT32 *) (a), (UINT32 *) (b))
#define TX_POINTER_TO_ULONG_CONVERT(a)                  _tx_misra_pointer_to_ulong_convert((VOID *) (a))
#define TX_ULONG_TO_POINTER_CONVERT(a)                  _tx_misra_ulong_to_pointer_convert((UINT32) (a))
...
#define TX_TIMER_POINTER_ADD(a,b)                       _tx_misra_timer_pointer_add((TX_TIMER_INTERNAL **) (a), (UINT32) (b))
...
#define TX_POINTER_TO_ALIGN_TYPE_CONVERT(a)             TX_POINTER_TO_ULONG_CONVERT((a))
#define TX_ALIGN_TYPE_TO_POINTER_CONVERT(a)             TX_ULONG_TO_POINTER_CONVERT((a))
...
#define TX_UCHAR_POINTER_DIF(a,b)                       ((UINT32)(((UCHAR *) (a)) - ((UCHAR *) (b))))
#define TX_ULONG_POINTER_ADD(a,b)                       (((UINT32 *) (a)) + ((UINT) (b)))
#define TX_ULONG_POINTER_SUB(a,b)                       (((UINT32 *) (a)) - ((UINT) (b)))
#define TX_ULONG_POINTER_DIF(a,b)                       ((UINT32)(((UINT32 *) (a)) - ((UINT32 *) (b))))
#define TX_POINTER_TO_ULONG_CONVERT(a)                  ((UINT32) ((VOID *) (a)))
#define TX_ULONG_TO_POINTER_CONVERT(a)                  ((VOID *) ((UINT32) (a)))
#define TX_POINTER_TO_ALIGN_TYPE_CONVERT(a)             ((ALIGN_TYPE) ((VOID *) (a)))
#define TX_ALIGN_TYPE_TO_POINTER_CONVERT(a)             ((VOID *) ((ALIGN_TYPE) (a)))
#define TX_TIMER_POINTER_DIF(a,b)                       ((UINT32)(((TX_TIMER_INTERNAL **) (a)) - ((TX_TIMER_INTERNAL **) (b))))
#define TX_TIMER_POINTER_ADD(a,b)                       (((TX_TIMER_INTERNAL **) (a)) + ((UINT32) (b)))
...
#define TX_VOID_TO_ULONG_POINTER_CONVERT(a)             ((UINT32 *) ((VOID *) (a)))
