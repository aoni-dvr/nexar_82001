...
#define TX_INITIALIZE_IN_PROGRESS               ((UINT32) 0xF0F0F0F0UL)
#define TX_INITIALIZE_ALMOST_DONE               ((UINT32) 0xF0F0F0F1UL)
#define TX_INITIALIZE_IS_FINISHED               ((UINT32) 0x00000000UL)
