...
/*                                            corrected next priority     */
/*                                            find for priority levels    */
/*                                            greater than 32,            */
/*                                            resulting in version 5.7    */
/*  04-01-2016     William E. Lamie         Modified comment(s), added    */
/*                                            optimized in-line helper    */
/*                                            functions, and added        */
/*                                            preemption-threshold list,  */
...
#define TX_THREAD_ID                            ((UINT32) 0x54485244)
#define TX_THREAD_MAX_BYTE_VALUES               256
#define TX_THREAD_PRIORITY_GROUP_MASK           ((UINT32) 0xFF)
...
#define TX_THREAD_STACK_CHECK(thread_ptr)                                                                                       \
    ...
    TX_INTERRUPT_SAVE_AREA                                                                                                      \
        ...
        {                                                                                                                       \
            if (((UINT32 *) (thread_ptr) -> tx_thread_stack_ptr) < ((UINT32 *) (thread_ptr) -> tx_thread_stack_highest_ptr))      \
            {                                                                                                                   \
            ...
            if ((*((UINT32 *) (thread_ptr) -> tx_thread_stack_start) != TX_STACK_FILL) ||                                        \
                ...
                (((UINT32 *) (thread_ptr) -> tx_thread_stack_highest_ptr) < ((UINT32 *) (thread_ptr) -> tx_thread_stack_start)))  \
            {                                                                                                                   \
                TX_RESTORE                                                                                                      \
                _tx_thread_stack_error_handler((thread_ptr));                                                                   \
                TX_DISABLE                                                                                                      \
            }                                                                                                                   \
            if (*(((UINT32 *) (thread_ptr) -> tx_thread_stack_highest_ptr) - 1) != TX_STACK_FILL)                                \
            {                                                                                                                   \
                TX_RESTORE                                                                                                      \
...
VOID        _tx_thread_system_ni_suspend(TX_THREAD *thread_ptr, UINT32 timeout);
VOID        _tx_thread_time_slice(VOID);
VOID        _tx_thread_timeout(UINT32 timeout_input);


/* Define all internal SMP prototypes.  */

void        _tx_thread_smp_current_state_set(UINT32 new_state);
...
THREAD_DECLARE  UINT32                       _tx_thread_smp_reschedule_pending;
THREAD_DECLARE  TX_THREAD_SMP_PROTECT       _tx_thread_smp_protection;
THREAD_DECLARE  volatile UINT32              _tx_thread_smp_release_cores_flag;
THREAD_DECLARE  UINT32                       _tx_thread_smp_system_error;
THREAD_DECLARE  UINT32                       _tx_thread_smp_inter_core_interrupts[TX_THREAD_SMP_MAX_CORES];

THREAD_DECLARE  UINT32                       _tx_thread_smp_protect_wait_list_size;
THREAD_DECLARE  UINT32                       _tx_thread_smp_protect_wait_list[TX_THREAD_SMP_PROTECT_WAIT_LIST_SIZE];
THREAD_DECLARE  UINT32                       _tx_thread_smp_protect_wait_counts[TX_THREAD_SMP_MAX_CORES];
THREAD_DECLARE  UINT32                       _tx_thread_smp_protect_wait_list_lock_protect_in_force;
THREAD_DECLARE  UINT32                       _tx_thread_smp_protect_wait_list_tail;
THREAD_DECLARE  UINT32                       _tx_thread_smp_protect_wait_list_head;
...
THREAD_DECLARE  UINT32                       _tx_thread_smp_max_cores;
THREAD_DECLARE  UINT32                       _tx_thread_smp_detected_cores;
...
THREAD_DECLARE  UINT32                       _tx_thread_created_count;
...
THREAD_DECLARE  volatile UINT32              _tx_thread_system_state[TX_THREAD_SMP_MAX_CORES];
...
THREAD_DECLARE  UINT32                       _tx_thread_priority_maps[TX_MAX_PRIORITIES/32];
...
THREAD_DECLARE  UINT32                       _tx_thread_priority_map_active;
#endif
...
THREAD_DECLARE  UINT32                       _tx_thread_preempted_maps[TX_MAX_PRIORITIES/32];
...
#if TX_MAX_PRIORITIES > 32
THREAD_DECLARE  UINT32                       _tx_thread_preempted_map_active;
#endif
...
THREAD_DECLARE  TX_THREAD                   *_tx_thread_preemption_threshold_list[TX_MAX_PRIORITIES] __attribute__((section(".bss.noinit")));
...
THREAD_DECLARE  TX_THREAD *                 _tx_thread_priority_list[TX_MAX_PRIORITIES] __attribute__((section(".bss.noinit")));
...
THREAD_DECLARE  UINT32                       _tx_build_options;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_solicited_preemption_count;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_interrupt_preemption_count;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_priority_inversion_count;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_time_slice_count;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_relinquish_count;


/* Define the total number of thread timeouts. Each time a thread has a
   timeout this variable is incremented.  */

THREAD_DECLARE  UINT32                       _tx_thread_performance_timeout_count;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_wait_abort_count;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_idle_return_count;
...
THREAD_DECLARE  UINT32                       _tx_thread_performance_non_idle_return_count;
...
#define TX_MOD32_BIT_SET(a,b)                   (b) = (((UINT32) 1) << ((a)%((UINT) 32)));
#endif
#else
#define MAP_INDEX                               (0)
#ifndef TX_MOD32_BIT_SET
#define TX_MOD32_BIT_SET(a,b)                   (b) = (((UINT32) 1) << ((a)));
#endif
#endif
...
#define TX_DIV32_BIT_SET(a,b)                   (b) = (((UINT32) 1) << ((a)/((UINT) 32)));
#endif
#endif
...
#define TX_THREAD_SYSTEM_RETURN_CHECK(c)    (c) = (UINT32) _tx_thread_preempt_disable; (c) = (c) | TX_THREAD_GET_SYSTEM_STATE();
#endif
...
static INLINE_DECLARE UINT  _tx_thread_lowest_set_bit_calculate(UINT32 map)
{
UINT    bit_set;

    if ((map & ((UINT32) 0x1)) != ((UINT32) 0))
    {
        bit_set = ((UINT) 0);
    }
    else
    {
        map =  map & (UINT32) ((~map) + ((UINT32) 1));
        if (map < ((UINT32) 0x100))
        {
            bit_set = ((UINT) 1);
        }
        else if (map < ((UINT32) 0x10000))
        {
            bit_set =  ((UINT) 9);
            map =  map >> ((UINT) 8);
        }
        else if (map < ((UINT32) 0x01000000))
        {
            bit_set = ((UINT) 17);
            map = map >> ((UINT) 16);
        }
        ...
        bit_set = bit_set - (UINT) (map & (UINT32) 0x1);
    }
...
{
UINT32           map_index;
UINT32           local_priority_map_active;
UINT32           local_priority_map;
UINT32           priority_bit;
UINT32           first_bit_set;
UINT32           found_priority;
    ...
    if (priority < ((UINT) TX_MAX_PRIORITIES))
    {
        ...
        priority_bit =        (((UINT32) 1) << (priority % ((UINT) 32)));
        local_priority_map =  local_priority_map & ~(priority_bit - ((UINT)1));
        if (local_priority_map != ((UINT32) 0))
        {
...
static INLINE_DECLARE UINT32  _tx_thread_smp_available_cores_get(void)
{

#if TX_THREAD_SMP_MAX_CORES > 6
UINT    j;
#endif
UINT32   available_cores;

    available_cores =  ((UINT32) 0);
    if (_tx_thread_execute_ptr[0] == TX_NULL)
    {
        available_cores =  ((UINT32) 1);
    }
#if TX_THREAD_SMP_MAX_CORES > 1
    if (_tx_thread_execute_ptr[1] == TX_NULL)
    {
        available_cores =  available_cores | ((UINT32) 2);
    }
#if TX_THREAD_SMP_MAX_CORES > 2
    if (_tx_thread_execute_ptr[2] == TX_NULL)
    {
        available_cores =  available_cores | ((UINT32) 4);
    }
#if TX_THREAD_SMP_MAX_CORES > 3
    if (_tx_thread_execute_ptr[3] == TX_NULL)
    {
        available_cores =  available_cores | ((UINT32) 8);
    }
#if TX_THREAD_SMP_MAX_CORES > 4
    if (_tx_thread_execute_ptr[4] == TX_NULL)
    {
        available_cores =  available_cores | ((UINT32) 0x10);
    }
#if TX_THREAD_SMP_MAX_CORES > 5
    if (_tx_thread_execute_ptr[5] == TX_NULL)
    {
        available_cores =  available_cores | ((UINT32) 0x20);
    }
#if TX_THREAD_SMP_MAX_CORES > 6
...
#endif
    {
        ...
        {
            available_cores =  available_cores | (((UINT32) 1) << j);
        }
...
static INLINE_DECLARE UINT32  _tx_thread_smp_possible_cores_get(void)
{

#if TX_THREAD_SMP_MAX_CORES > 6
UINT    j;
#endif
UINT32       possible_cores;
TX_THREAD   *thread_ptr;

    possible_cores =  ((UINT32) 0);
...
static INLINE_DECLARE UINT  _tx_thread_smp_remap_solution_find(TX_THREAD *schedule_thread, UINT32 available_cores, UINT32 thread_possible_cores, UINT32 test_possible_cores)
{

UINT            core;
UINT            previous_core;
UINT32           test_cores;
UINT32           last_thread_cores;
...
TX_THREAD       *thread_remap_list[TX_THREAD_SMP_MAX_CORES];
    ...
    if ((thread_possible_cores & (((UINT32) 1) << core)) != ((UINT32) 0))
    {
        ...
        /* Clear this core.  */
        thread_possible_cores =  thread_possible_cores & ~(((UINT32) 1) << core);
    }

    /* Loop to add additional possible cores.  */
    while (thread_possible_cores != ((UINT32) 0))
    {
    ...
    do
    {
        ...
        if (thread_ptr != TX_NULL)
        {
            ...
            if (thread_possible_cores != ((UINT32) 0))
            {

                /* Determine if there are cores available for this thread.  */
                if ((thread_possible_cores & available_cores) != ((UINT32) 0))
                {
...
static INLINE_DECLARE UINT32  _tx_thread_smp_preemptable_threads_get(UINT priority, TX_THREAD *possible_preemption_list[])
{
...
TX_THREAD   *list_head;
UINT32       possible_cores =  ((UINT32) 0);
...
UINT            map_index;
    ...
    else
    {
        ...
        if (_tx_thread_priority_maps[MAP_INDEX] == ((UINT32) 0))
        {
...
UINT   _tx_thread_lowest_set_bit_calculate(UINT32 map);
#define TX_LOWEST_SET_BIT_CALCULATE(m, b)   (b) =  _tx_thread_lowest_set_bit_calculate((m));
...
UINT32  _tx_thread_smp_available_cores_get(void);
UINT32  _tx_thread_smp_possible_cores_get(void);
UINT   _tx_thread_smp_lowest_priority_get(void);
UINT   _tx_thread_smp_remap_solution_find(TX_THREAD *schedule_thread, UINT32 available_cores, UINT32 thread_possible_cores, UINT32 test_possible_cores);
UINT32  _tx_thread_smp_preemptable_threads_get(UINT priority, TX_THREAD *possible_preemption_list[]);
