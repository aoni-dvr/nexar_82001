...
/*                                            modified code to sync with  */
/*                                            standard ThreadX tx_trace.h,*/
...
typedef struct TX_TRACE_HEADER_STRUCT
{
    ...
    UINT32                                                   tx_trace_header_id;
    UINT32                                                   tx_trace_header_timer_valid_mask;
    UINT32                                                   tx_trace_header_trace_base_address;
    UINT32                                                   tx_trace_header_registry_start_pointer;
    USHORT                                                  tx_trace_header_reserved1;
    USHORT                                                  tx_trace_header_object_name_size;
    UINT32                                                   tx_trace_header_registry_end_pointer;
    UINT32                                                   tx_trace_header_buffer_start_pointer;
    UINT32                                                   tx_trace_header_buffer_end_pointer;
    UINT32                                                   tx_trace_header_buffer_current_pointer;
    UINT32                                                   tx_trace_header_reserved2;
    UINT32                                                   tx_trace_header_reserved3;
    UINT32                                                   tx_trace_header_reserved4;
} TX_TRACE_HEADER;
...
typedef struct TX_TRACE_OBJECT_ENTRY_STRUCT
{
    ...
    UINT32                                                   tx_trace_object_entry_thread_pointer;                       /* ThreadX object pointer               */
    UINT32                                                   tx_trace_object_entry_param_1;                              /* Parameter value defined              */
    UINT32                                                   tx_trace_object_entry_param_2;                              /*   according to type above            */
...
typedef struct TX_TRACE_BUFFER_ENTRY_STRUCT
{
    ...
    UINT32                                                   tx_trace_buffer_entry_thread_pointer;
    UINT32                                                   tx_trace_buffer_entry_thread_priority;
    UINT32                                                   tx_trace_buffer_entry_event_id;
    UINT32                                                   tx_trace_buffer_entry_time_stamp;
#ifdef TX_MISRA_ENABLE
    UINT32                                                   tx_trace_buffer_entry_info_1;
    UINT32                                                   tx_trace_buffer_entry_info_2;
    UINT32                                                   tx_trace_buffer_entry_info_3;
    UINT32                                                   tx_trace_buffer_entry_info_4;
#else
    UINT32                                                   tx_trace_buffer_entry_information_field_1;
    UINT32                                                   tx_trace_buffer_entry_information_field_2;
    UINT32                                                   tx_trace_buffer_entry_information_field_3;
    UINT32                                                   tx_trace_buffer_entry_information_field_4;
#endif
...
TRACE_DECLARE  UINT32                            _tx_trace_event_enable_bits;
...
TRACE_DECLARE  UINT32                             _tx_trace_simulated_time;
...
TRACE_DECLARE  UINT32                             _tx_trace_total_registry_entries;


/* Define a counter that is used to track the number of available registry entries.  */

TRACE_DECLARE  UINT32                             _tx_trace_available_registry_entries;


/* Define an index that represents the start of the registry search.  */

TRACE_DECLARE  UINT32                             _tx_trace_registry_search_start;


/* Define the event trace macros that are expanded in-line when event tracing is enabled.  */

#ifdef TX_MISRA_ENABLE
#define TX_TRACE_INFO_FIELD_ASSIGNMENT(a,b,c,d)  trace_event_ptr -> tx_trace_buffer_entry_info_1 =  (UINT32) (a); trace_event_ptr -> tx_trace_buffer_entry_info_2 =  (UINT32) (b); trace_event_ptr -> tx_trace_buffer_entry_info_3 =  (UINT32) (c); trace_event_ptr -> tx_trace_buffer_entry_info_4 =  (UINT32) (d);
#else
#define TX_TRACE_INFO_FIELD_ASSIGNMENT(a,b,c,d)  trace_event_ptr -> tx_trace_buffer_entry_information_field_1 =  (UINT32) (a); trace_event_ptr -> tx_trace_buffer_entry_information_field_2 =  (UINT32) (b); trace_event_ptr -> tx_trace_buffer_entry_information_field_3 =  (UINT32) (c); trace_event_ptr -> tx_trace_buffer_entry_information_field_4 =  (UINT32) (d);
#endif


#define TX_TRACE_INITIALIZE                                     _tx_trace_initialize();
#define TX_TRACE_OBJECT_REGISTER(t,p,n,a,b)                     _tx_trace_object_register((UCHAR) (t), (VOID *) (p), (CHAR *) (n), (UINT32) (a), (UINT32) (b));
...
#define TX_TRACE_IN_LINE_INSERT(i,a,b,c,d,e) \
        ...
        UINT32                      core; \
            ...
            if ((trace_event_ptr) && (_tx_trace_event_enable_bits & ((UINT32) (e)))) \
            { \
                TX_TRACE_PORT_EXTENSION \
                trace_system_state =  (UINT32) _tx_thread_smp_current_state_get(); \
                TX_THREAD_GET_CURRENT(trace_thread_ptr) \
                \
                if (trace_system_state == ((UINT32) 0)) \
                { \
                ...
                trace_event_ptr -> tx_trace_buffer_entry_event_id =             (UINT32) (core << 24) | (i); \
                trace_event_ptr -> tx_trace_buffer_entry_time_stamp =           (UINT32) TX_TRACE_TIME_SOURCE; \
...
VOID    _tx_trace_object_register(UCHAR object_type, VOID *object_ptr, CHAR *object_name, UINT32 parameter_1, UINT32 parameter_2);
