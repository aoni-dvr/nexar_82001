...
/* Determine if enabling ThreadX MISRA compliance is required. By default, the MISRA compliance is
   disabled since it will degrade performance. It is not sufficient for this to be defined in 
   tx_port.h or tx_user.h. */
...
/* Define system library include files.  */
#ifndef AMBA_TYPES_H
#include "AmbaTypes.h"
#endif

/* This definition is used to enables Newlib library support on managing _reent structures  */
/* Newlib library supporting is related to GCC toolchain version.                           */
/* It should be always defined for current toolchain.                                       */
/*
#define CONFIG_SSP_THREADX_NEWLIB
*/
