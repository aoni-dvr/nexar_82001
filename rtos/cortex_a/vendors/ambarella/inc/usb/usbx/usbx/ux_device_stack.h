...
UINT    _ux_device_stack_class_register(UCHAR *class_name,
                                        UINT (*class_entry_function)(struct UX_SLAVE_CLASS_COMMAND_STRUCT *command),
...
UINT    _ux_device_stack_ss_initialize(UCHAR * device_framework_super_speed, ULONG device_framework_length_super_speed);
UINT    _ux_device_stack_initialize(UCHAR * device_framework_high_speed, ULONG device_framework_length_high_speed,
                                    UCHAR * device_framework_full_speed, ULONG device_framework_length_full_speed,
                                    UCHAR * string_framework, ULONG string_framework_length,
                                    UCHAR * language_id_framework, ULONG language_id_framework_length,
                                    UINT (*ux_system_slave_change_function)(ULONG arg));
UINT    _ux_device_stack_interface_delete(UX_SLAVE_INTERFACE *intf);
UINT    _ux_device_stack_interface_get(UINT interface_value);
UINT    _ux_device_stack_interface_set(UCHAR * device_framework, ULONG device_framework_length,
                                       ULONG alternate_setting_value);
UINT    _ux_device_stack_interface_start(UX_SLAVE_INTERFACE *intf);
...
UINT  	_ux_device_stack_microsoft_extension_register(ULONG vendor_request,
        UINT (*vendor_request_function)(ULONG request, ULONG value, ULONG index, ULONG length, UCHAR *buffer, ULONG *buffer_length));
VOID    uxd_ep_xfer_timeout_set(UINT value);
UINT    uxd_ep_xfer_timeout_get(void);
UINT    uxd_ep_in_max_dlen_set(UINT32 value);
UINT    uxd_ep_in_max_dlen_get(void);
UINT    uxd_ep_out_max_dlen_set(UINT32 value);
UINT    uxd_ep_out_max_dlen_get(void);
#endif
