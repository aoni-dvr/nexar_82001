...
/*
 * ------------------------------------------------------------------
 * Samsung Exynosauto9 support
 * ------------------------------------------------------------------
 */
extern void init_exynos(unsigned, const char *, const char *);
extern void put_exynos(int);

extern struct callout_rtn   display_char_exynos;
extern struct callout_rtn   poll_key_exynos;
extern struct callout_rtn   break_detect_exynos;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/aarch64/cpu_startup.h $ $Rev: 894795 $")
#endif
