...
#define AA64PFR0_SIMD(x)    ((((x) >> 20) & 0xfUL) == 0)
#define AA64PFR0_FP(x)      ((((x) >> 16) & 0xfUL) == 0)
...
init_one_cpuinfo(unsigned cpunum)
{
     ...
     */
#if !defined(AARCH64_CPU_SPECTRE_V2_FIX) || !defined(AARCH64_CPU_SPECTRE_V2_MMU)
//  2018-10-22.
//  This needs to be removed once we merge aarch64/syspage.h from mainline to 700.
//  It is defined here to allow mainline BSPs to be built against 700 header.
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/startup/lib/aarch64/init_cpuinfo.c $ $Rev: 886103 $")
#endif
